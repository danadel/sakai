...
package org.sakaiproject.weblink.tool;
...
//		System.out.println(" ----------- IFrameAction.buildMainPanelContext -------------");
		...
		//Properties properties = toolManager.getCurrentTool().getRegisteredConfig();
		Properties properties = ToolManager.getCurrentTool().getRegisteredConfig();
		String filename = properties.getProperty("configfile");
		System.out.println("Leemos la Propiedad..."+filename);

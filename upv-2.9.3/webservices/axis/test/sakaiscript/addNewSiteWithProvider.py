...
newSite = scriptsoap.addNewSiteWithProvider( sessionid, siteid, title, description, shortdesc, infourl, skin, tipo, provider, term, asiupv, propietario, aluficticioid, aluficticiopwd)

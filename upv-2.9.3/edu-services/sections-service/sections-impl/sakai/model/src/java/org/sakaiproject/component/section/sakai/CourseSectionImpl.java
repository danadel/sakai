/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/edu-services/sections-service/sections-impl/sakai/model/src/java/org/sakaiproject/component/section/sakai/CourseSectionImpl.java $
 * $Id: CourseSectionImpl.java 318026 2015-03-17 15:08:59Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public class CourseSectionImpl implements CourseSection, Comparable<CourseSection>, Serializable {
     ...
     */
    public void decorateGroup(Group group, boolean addUpdateSiteParam) {
    	ResourceProperties props = group.getProperties();
    	...
    	// this go in conjuction with samoo functionality keep manually created groups
    	if (addUpdateSiteParam) {
    		props.addProperty("update_site_properties", "false");
    	}
    }

/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/edu-services/sections-service/sections-impl/sakai/impl/src/java/org/sakaiproject/component/section/sakai/CourseSectionUtil.java $
 * $Id: CourseSectionUtil.java 318026 2015-03-17 15:08:59Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public class CourseSectionUtil {
	public static final CourseSection decorateGroupWithCmSection(Group group, Section officialSection) {
		...
		section.decorateGroup(group, false);
		return section;
	}
		return null;
	}

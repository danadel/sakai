/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/edu-services/sections-service/sections-impl/standalone/src/java/org/sakaiproject/component/section/SectionManagerHibernateImpl.java $
 * $Id: SectionManagerHibernateImpl.java 131950 2013-11-26 15:17:37Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public class SectionManagerHibernateImpl extends HibernateDaoSupport implements
	...
	public void setOpenDate(final String courseUuid, final Calendar openDate) {
       ...
       public void resetSections(Site site){
    	   log.warn("resetSections + SectionManagerHibernateImpl");
       }
}

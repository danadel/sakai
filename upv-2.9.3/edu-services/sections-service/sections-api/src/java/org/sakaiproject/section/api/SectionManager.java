/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/edu-services/sections-service/sections-api/src/java/org/sakaiproject/section/api/SectionManager.java $
 * $Id: SectionManager.java 131950 2013-11-26 15:17:37Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public interface SectionManager {
	...
	/**
	 * Deletes all the inactive (manually managed) sections of the site.
	 *
	 * @param site
	 * @return
	 */

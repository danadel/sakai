/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/msgcntr/messageforums-component-impl/src/java/org/sakaiproject/component/app/messageforums/EmailNotificationManagerImpl.java $
 * $Id: EmailNotificationManagerImpl.java 132357 2013-12-09 10:37:21Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public class EmailNotificationManagerImpl extends HibernateDaoSupport implements
	...
	public EmailNotification getEmailNotification(final String userId) {
		...
		if (emailNotification == null) {
			...
			} else if ("3".equals(notificationDefault)) {
			    newEmailNotification
					.setNotificationLevel(EmailNotification.EMAIL_REPLY_TO_MY_MESSAGE_BUT_NO_MY_MESSAGES); 
			}else {
			    newEmailNotification

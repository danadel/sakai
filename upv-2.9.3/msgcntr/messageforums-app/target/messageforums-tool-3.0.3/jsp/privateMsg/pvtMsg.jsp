...
<f:view>
	<sakai:view title="#{msgs.pvtarea_name}" toolCssHref="/messageforums-tool/css/msgcntr.css">
...
%>
	  ...
	  <h:dataTable styleClass="listHier lines nolines" cellpadding="0" cellspacing="0"  id="pvtmsgs" width="100%" value="#{PrivateMessagesTool.decoratedPvtMsgs}" var="rcvdItems" 
		  ...
		  <h:column>
            ...
            <h:outputText styleClass="readMsg" value=" #{rcvdItems.msg.title}" rendered="#{rcvdItems.hasRead}"/>

...
/////////////modified by hu2@iupui.edu  begin
  ...
  public String processPvtMsgSend() {
    ...
    String msgSendEmailOut = "/sendEmail=" + Boolean.valueOf(isSendEmail()).toString();
    ...
    EventTrackingService.post(EventTrackingService.newEvent(DiscussionForumService.EVENT_MESSAGES_ADD, getEventMessage(pMsg) + msgSendEmailOut, false));

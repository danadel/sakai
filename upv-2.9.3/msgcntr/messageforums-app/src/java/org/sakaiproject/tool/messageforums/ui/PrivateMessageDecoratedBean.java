/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/msgcntr/messageforums-app/src/java/org/sakaiproject/tool/messageforums/ui/PrivateMessageDecoratedBean.java $
 * $Id: PrivateMessageDecoratedBean.java 132354 2013-12-09 08:05:31Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public class PrivateMessageDecoratedBean 
{
  ...
  public boolean getExternalEmail(){
	  return this.msg.getExternalEmail() != null && this.msg.getExternalEmail();
  }
}

				...
				<p class="instruction">
				  ...
				  <h:panelGroup>
					  <h:selectOneRadio layout="pageDirection" id="emailNotificationOption"  value="#{ForumTool.watchSettingsBean.emailNotification.notificationLevel}">
    					<f:selectItem itemValue="4" itemLabel="#{msgs.notify_for_postings_to_my_thread_but_not_mine}"/>
    					<f:selectItem itemValue="3" itemLabel="#{msgs.notify_for_all_postings_but_not_mine}"/>					

...
public class UserNotificationProviderImpl implements UserNotificationProvider {
	...
	public void notifyAddedParticipant(boolean newNonOfficialAccount,
		...
		if (from != null) {
			...
			buf.append(rb.getFormattedMessage("java.following", new Object[]{productionSiteName, "\n" + siteTitle + "\n"}));
			...
			if (newNonOfficialAccount) {
				...
				buf.append(rb.getString("java.loginhow4") + "\n");
				buf.append(rb.getString("java.loginhow5") + "\n");
				buf.append(rb.getString("java.loginhow6") + "\n");
			} else {

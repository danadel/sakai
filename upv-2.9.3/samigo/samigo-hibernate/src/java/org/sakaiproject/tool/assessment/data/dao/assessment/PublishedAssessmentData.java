/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-hibernate/src/java/org/sakaiproject/tool/assessment/data/dao/assessment/PublishedAssessmentData.java $
 * $Id: PublishedAssessmentData.java 131695 2013-11-18 12:06:37Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public class PublishedAssessmentData
  ...
  static Category errorLogger = Category.getInstance("errorLogger");
  	...
  	private static Log log = LogFactory
			.getLog(PublishedAssessmentData.class);
...
////  private AssessmentIfc assessment;
                                 ...
                                 Integer submissionsAllowed)
 {
  ...
  public PublishedAssessmentData(Long id, String title, String releaseTo,
                                 ...
                                 Integer lateHandling,
                                 Boolean unlimitedSubmissions,
                                 Integer submissionsAllowed, Integer scoringType, Integer status, Date lastModifiedDate, Integer timeLimit, Boolean satisfiesRule, String conditionalAccessList) {
    this.assessmentBaseId = id;
    this.title = title;
    this.releaseTo = releaseTo;
    this.startDate = startDate;
      ...
      if ((s.getSectionMetaDataByLabel(SectionDataIfc.AUTHOR_TYPE)!=null) && (s.getSectionMetaDataByLabel(SectionDataIfc.AUTHOR_TYPE).equals(SectionDataIfc.RANDOM_DRAW_FROM_QUESTIONPOOL.toString())))
{
  ...
  public Boolean getSatisfiesRule() {
  ...
  public void setNotificationId(String n){
	  this.notificationId = n;
  }
  public Boolean getUseConditionalRelease(){
	  return this.useConditionalRelease;
  }
  public void setUseConditionalRelease(Boolean b){
	  this.useConditionalRelease = b;
  } 
}

/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-hibernate/src/java/org/sakaiproject/tool/assessment/data/dao/assessment/AssessmentData.java $
 * $Id: AssessmentData.java 316693 2015-01-12 09:29:29Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
// both Assessment and AssessmentTemplate inherits all the properties & methods from
  ...
  public AssessmentData(Long assessmentTemplateId, String title, Integer status, Date lastModifiedDate, String lastModifiedBy){
	    // in the case of template assessmentBaseId is the assessmentTemplateId
	    super(assessmentTemplateId,title,status,lastModifiedDate,lastModifiedBy);
}

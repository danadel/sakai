...
public class ItemData
  ...
  private Set<ItemHistoricalIfc> itemHistoricalSet;
  ...
  {
	  List<ItemHistoricalIfc> historicalList = new ArrayList<ItemHistoricalIfc>();
	  Set<ItemHistoricalIfc> historicalSet = getItemHistoricalSet();
	  if (historicalSet != null)
	  {
		  for (Iterator<ItemHistoricalIfc> i = historicalSet.iterator(); i.hasNext(); ) 
		  {
			  historicalList.add(i.next());
		  }
	  }

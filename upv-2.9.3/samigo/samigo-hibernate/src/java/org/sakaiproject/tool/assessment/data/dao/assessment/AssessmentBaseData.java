/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-hibernate/src/java/org/sakaiproject/tool/assessment/data/dao/assessment/AssessmentBaseData.java $
 * $Id: AssessmentBaseData.java 316693 2015-01-12 09:29:29Z anueda@asic.upv.es $
 ***********************************************************************************
 *
               ...
               org.sakaiproject.tool.assessment.data.ifc.assessment.AssessmentBaseIfc
{
  ...
  public AssessmentBaseData(Long assessmentBaseId, String title, Integer status, Date lastModifiedDate, String lastModifiedBy){
	    this.assessmentBaseId = assessmentBaseId;
	    this.title = title;
	    this.status = status;
	    this.lastModifiedDate = lastModifiedDate;

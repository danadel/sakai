/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-hibernate/src/java/org/sakaiproject/tool/assessment/data/dao/assessment/PublishedAccessControl.java $
 * $Id: PublishedAccessControl.java 131695 2013-11-18 12:06:37Z anueda@asic.upv.es $
 ***********************************************************************************
 *
  ...
  /**
	...
	private static final long serialVersionUID = -221497966468066618L;
		...
		private static Log log = LogFactory
			.getLog(PublishedAccessControl.class);
...
// keep in mind that this id can be an assesmentId or assessmentTemplateId.
  ...
  private Boolean useConditionalRelease;
  private String notificationId;
  private Boolean satisfiesRule;
  //private List conditionalAccessList;
  private String conditionalAccessList;
  ...
  public Object clone() throws CloneNotSupportedException{
    ...
    ((PublishedAccessControl)cloned).setUseConditionalRelease(this.useConditionalRelease);
    ((PublishedAccessControl)cloned).setNotificationId(this.notificationId);
    ((PublishedAccessControl)cloned).setSatisfiesRule(this.satisfiesRule);
    ((PublishedAccessControl)cloned).setConditionalAccessList(this.conditionalAccessList);
    return cloned;
  }
  ...
  public Boolean isSatisfiesRule() {
	  return this.satisfiesRule;
  }
	  
  public void setSatisfiesRule(Boolean satisfiesRule) {
	  this.satisfiesRule = satisfiesRule;
  }
	    
  public String getConditionalAccessList() {
	  return this.conditionalAccessList;
  }
	  
  public void setConditionalAccessList(String conditionalAccessList) {
	  this.conditionalAccessList = conditionalAccessList;
  }  

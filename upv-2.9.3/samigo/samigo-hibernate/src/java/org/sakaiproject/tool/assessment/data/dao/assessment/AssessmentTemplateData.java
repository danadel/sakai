/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-hibernate/src/java/org/sakaiproject/tool/assessment/data/dao/assessment/AssessmentTemplateData.java $
 * $Id: AssessmentTemplateData.java 131836 2013-11-21 16:31:37Z anueda@asic.upv.es $
 ***********************************************************************************
 *
               ...
               org.sakaiproject.tool.assessment.data.ifc.assessment.AssessmentTemplateIfc
{
  ...
  public AssessmentTemplateData(Long assessmentTemplateId, String title, Date lastModifiedDate, Long typeId, String createdBy){
    super(assessmentTemplateId,title,lastModifiedDate,typeId);

...
<!--
* $Id: multipleChoice.jsp 310284 2014-06-17 15:25:12Z anueda@asic.upv.es $
<%--
***********************************************************************************
*
...
<h:inputText id="answerptr" value="#{itemauthor.currentItem.itemScore}" required="true"  disabled="#{author.pointValueHasOverrided}" size="6" onchange="toPoint(this.id);">
...
<div id="discountDiv" class="longtext">
  ...
  <h:inputText id="answerdsc" value="#{itemauthor.currentItem.itemDiscount}" required="true" disabled="#{author.pointValueHasOverrided}" onchange="toPoint(this.id);">

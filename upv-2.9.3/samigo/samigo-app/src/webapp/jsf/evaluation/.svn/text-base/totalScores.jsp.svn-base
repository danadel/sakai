...
function showMessage(){
	alert('<h:outputText value="#{evaluationMessages.showMessage}"/>');
}

function mailto(eml, msb) {
	var browser = navigator.userAgent.toLowerCase(); 
	
	if(browser.indexOf('chrome') != -1 || browser.indexOf('chromium') != -1){
...
<h:panelGrid columns="2" columnClasses="samLeftNav,samRightNav" width="100%">
  <h:panelGroup>
    <h:panelGrid columns="1" columnClasses="samLeftNav" width="100%">
	  ...
	  <!-- EVALUATION MODE -->
	  <h:panelGroup rendered="#{totalScores.releasedToGroups}">
        <h:outputText value="#{evaluationMessages.evaluationMode}"/>
        <h:outputText value="#{evaluationMessages.column}"/>
        <h:selectOneMenu value="#{totalScores.selectedEvaluationMode}" id="evaluationpicker" required="true" onchange="document.forms[0].submit();">
            <f:selectItem itemValue="1" itemLabel="#{evaluationMessages.evaluationMode1}" />
			<f:selectItem itemValue="2" itemLabel="#{evaluationMessages.evaluationMode2}" />
...
<h:panelGrid columns="2" columnClasses="samLeftNav,samRightNav" width="100%" rendered="#{totalScores.selectedEvaluationMode == 2}">
  <h:panelGroup rendered="#{totalScores.releasedToGroups}">
    <h:panelGrid columns="1" columnClasses="samLeftNav" width="100%">
	  <h:panelGroup>
        <h:outputText value="#{evaluationMessages.collective_text}"/>
	  </h:panelGroup>   
	  ...
	  <h:panelGroup>
	    <h:outputText value="#{evaluationMessages.cTime}" />
		<h:outputText value="#{evaluationMessages.column}"/>
	    <h:outputText value="#{totalScores.currentTime}" >
	  ...
	  <h:panelGroup>
		...
		<h:outputText value="#{evaluationMessages.column}"/>
	    <h:inputText value="#{totalScores.globalTotalScore}" id="globalTotalScore" size="5" required="false" />
	  </h:panelGroup>
	  
	  <h:panelGroup>
        <h:outputText value="#{evaluationMessages.adjustment}" />
		<h:outputText value="#{evaluationMessages.column}"/>		<!-- topoint -->
        <h:inputText value="#{totalScores.globalTotalOverrideScore}" size="5" id="globalTotalOverrideScore" required="false" >
	    </h:inputText>
      </h:panelGroup>
	  
	  <h:panelGroup>
	   <h:panelGrid>
        <h:outputText value="#{evaluationMessages.comment_for_students}" />
        <h:inputTextarea id="globalComments" value="#{totalScores.globalComments}" rows="3" cols="30" />
		 </h:panelGrid>
      </h:panelGroup>
	  
	  <h:panelGroup>
        <h:outputText value="#{evaluationMessages.collective_warning}"/>      
	  </h:panelGroup>
	</h:panelGrid>
  </h:panelGroup>
</h:panelGrid>  

<h:panelGrid columns="2" columnClasses="samLeftNav,samRightNav" width="100%" rendered="#{totalScores.anonymous eq 'false' && totalScores.selectedEvaluationMode == 1}">
  <h:panelGroup>
    <h:panelGrid columns="1" columnClasses="samLeftNav" width="100%">
	  ...
	  <h:panelGroup>
        ...
        <h:outputText value="#{evaluationMessages.column}"/>
        <h:selectOneMenu value="#{totalScores.selectedSectionFilterValue}" id="sectionpicker" required="true" onchange="document.forms[0].submit();showMessage();">
     ...
     <h:selectOneMenu value="#{totalScores.allSubmissions}" id="allSubmissionsL1"
        required="true" onchange=";showMessage(); document.forms[0].submit();" rendered="#{totalScores.scoringOption eq '2' && totalScores.multipleSubmissionsAllowed eq 'true' }">
     ...
     <h:selectOneMenu value="#{totalScores.allSubmissions}" id="allSubmissionsH1"
        required="true" onchange=";showMessage(); document.forms[0].submit();" rendered="#{totalScores.scoringOption eq '1' && totalScores.multipleSubmissionsAllowed eq 'true' }">
      <f:selectItem itemValue="3" itemLabel="#{evaluationMessages.all_sub}" />
	 ...
	 <h:selectOneMenu value="#{totalScores.allSubmissions}" id="averageSubmissionA1" required="true" onchange=";showMessage(); document.forms[0].submit();" rendered="#{totalScores.scoringOption eq '4' && totalScores.multipleSubmissionsAllowed eq 'true' }">
	   <f:selectItem itemValue="3" itemLabel="#{evaluationMessages.all_sub}" />
...
<h:panelGrid columns="2" columnClasses="samLeftNav,samRightNav" width="100%" rendered="#{totalScores.anonymous eq 'true' && totalScores.selectedEvaluationMode == 1}">
  <h:panelGroup>
    <h:panelGrid columns="1" columnClasses="samLeftNav" width="100%">
	  <h:panelGroup rendered="#{!totalScores.hasRandomDrawPart}">
        <h:outputText value="#{evaluationMessages.max_score_poss}" style="instruction"/>
...
<div class="tier2">
  <h:dataTable cellpadding="0" cellspacing="0" id="totalScoreTable" value="#{totalScores.agents}"
    var="description" styleClass="listHier" columnClasses="textTable" rendered="#{totalScores.selectedEvaluationMode == 1}">
    ...
    <h:column rendered="#{totalScores.anonymous eq 'false' && totalScores.sortType ne 'lastName'}">
	 ...
	 <span class="itemAction">
	   <h:panelGroup rendered="#{description.email != null && description.email != '' && email.fromEmailAddress != null && email.fromEmailAddress != ''}">
		 <h:outputText value="<a href=\"javascript:mailto('" escape="false" />
	     <h:outputText value="#{description.email}', '#{totalScores.assessmentName} #{commonMessages.feedback}')" escape="false" />
	     <h:outputText value="\">" escape="false" />
  ...
  <h:panelGroup rendered="#{totalScores.selectedEvaluationMode == 1}">
...
<p class="act">
   ...
   <h:commandButton value="#{commonMessages.export_action}" rendered="#{totalScores.selectedEvaluationMode != 2}" action="#{totalScores.exportExcel}"/>

...
<!-- $Id: templateIndex.jsp 131836 2013-11-21 16:31:37Z anueda@asic.upv.es $
<%--
***********************************************************************************
*
     ...
     <!--h:panelGrid columns="1"-->
      ...
      <h:panelGroup rendered="#{authorization.deleteOwnTemplate}">
        <h:commandLink title="#{templateMessages.t_removeTemplate}" id="deletelink" action="confirmDeleteTemplate" immediate="true"
            rendered="#{(templateListItem.typeId ne '142' && templateListItem.isMine) || (person.isAdmin && (templateListItem.typeId eq '142' && templateListItem.idString ne '1'))}">
        ...
        <h:outputText value=" | " styleClass="itemAction" rendered="#{templateListItem.typeId ne '142' && templateListItem.isMine}"/>
        <h:commandLink title="#{templateMessages.t_shareTemplate}" id="sharelink" action="confirmShareTemplate" immediate="true"
            rendered="#{templateListItem.typeId ne '142' && templateListItem.isMine}">
          <h:outputText value="#{templateMessages.share_action}" styleClass="itemAction"/>
            <f:param name="templateId" value="#{templateListItem.idString}"/>
            <f:actionListener
                type="org.sakaiproject.tool.assessment.ui.listener.author.TemplateShareListener" />
        </h:commandLink>
      </h:panelGroup>
      <!--/h:panelGroup-->
     <!--/h:panelGrid-->

<!-- $Id: questionTreeTable.jsp 306127 2014-02-18 09:14:45Z anueda@asic.upv.es $
<%--
***********************************************************************************
*
...
<h:commandLink title="#{questionPoolMessages.t_editQuestion}" id="modify" action="#{itemauthor.doit}"
	rendered="#{questionpool.canEditQuestions == 'true'}" immediate="true">
...
<h:outputText escape="false" value="#{question.textHtmlStripped}"
	rendered="#{questionpool.canEditQuestions == 'false'}" />

...
<h:dataTable id="questions" value="#{questionpool.itemBean}" var="question" >
	...
	<h:panelGrid width="100%" columns="1" columnClasses="h3text">
		<h:panelGroup>
			<h:outputText value="#{questionPoolMessages.t_historical}" />
		</h:panelGroup>
	</h:panelGrid>
	
	<h:dataTable id="historical" value="#{question.itemData.itemHistorical}" var="historical" width="100%" >
		
		<h:column>
			<h:outputText value="#{historical.modifiedBy}" >
				<f:converter converterId="org.sakaiproject.tool.assessment.jsf.converter.UsermameConverter" />
			</h:outputText>
		</h:column>
	
		<h:column>
			<h:outputText value="#{historical.modifiedDate}" >
				<f:convertDateTime pattern="#{generalMessages.output_date}" />
			</h:outputText>
		</h:column>

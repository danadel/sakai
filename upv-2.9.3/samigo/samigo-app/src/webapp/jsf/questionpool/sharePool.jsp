    ...
    <h:column id="col3">
     	...
     	<h:panelGroup id="thirdcolumn">
        	<h:selectOneMenu value="#{agent.accessTypeId}" 
        		immediate="true" onchange="form.submit();" valueChangeListener="#{questionpoolshare.changePermisoSelect}">
...
<p class="act">
  ...
  <h:commandButton type="submit" immediate="true" id="Submit" value="#{questionPoolMessages.save}" action="#{questionpoolshare.sharePool}" >
  </h:commandButton>

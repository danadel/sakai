/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-app/src/java/org/sakaiproject/tool/assessment/ui/listener/author/RemovePublishedAssessmentListener.java $
 * $Id: RemovePublishedAssessmentListener.java 321456 2015-10-08 11:51:16Z anueda@asic.upv.es $
 ***********************************************************************************
 *
 ...
 * @author Ed Smiley
 * @version $Id: RemovePublishedAssessmentListener.java 321456 2015-10-08 11:51:16Z anueda@asic.upv.es $
 */
    ...
    implements ActionListener
{
  ...
  public void processAction(ActionEvent ae) throws AbortProcessingException
  {
    ...
    PublishedAssessmentSettingsBean assessmentSettings = (PublishedAssessmentSettingsBean) ContextUtil.lookupBean(
			"publishedSettings");
    assessmentSettings.setOutcome("removeAssessment");
    ...
    if (assessmentId != null)
    {
      ...
      if (!DeleteGradebookUtil.checkCanDeleteGradebook(context, 
		  ...
		  assessmentSettings.setOutcome("confirmRemovePublishedAssessment");
		  return;
	  }
      ...
      if(accessControl.getNotificationId()!=null){
    	  ...
    	  ach.removeExistingNotification(accessControl.getNotificationId());
    	  accessControl.setNotificationId(null);
    	  accessControl.setSatisfiesRule(null);
    	  accessControl.setConditionalAccessList(null);
    	  accessControl.setUseConditionalRelease(false);
      ...
      for (int i=0; i<publishedAssessmentList.size();i++){
        ...
        if (!(assessmentId).equals(pa.getPublishedAssessmentId().toString())) {
          list.add(pa);
        	...
        	assessment.setRemovedForDisplay(true);
        	list.add(assessment);
        }
      }

/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-app/src/java/org/sakaiproject/tool/assessment/ui/listener/delivery/SubmitToGradingActionListener.java $
 * $Id: SubmitToGradingActionListener.java 316481 2015-01-07 10:15:42Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public class SubmitToGradingActionListener implements ActionListener {
	...
	private void setConfirmationId(AssessmentGradingData adata,
		...
		delivery.setConfirmation(adata.getAssessmentGradingId() + "-"
				...
				+ adata.getAgentId() + "-"
				+ adata.getSubmittedDate() != null ? adata.getSubmittedDate().toString() : currentTime.toString());
	}

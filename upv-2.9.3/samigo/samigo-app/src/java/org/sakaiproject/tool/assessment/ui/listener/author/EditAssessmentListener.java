/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-app/src/java/org/sakaiproject/tool/assessment/ui/listener/author/EditAssessmentListener.java $
 * $Id: EditAssessmentListener.java 306359 2014-02-25 07:49:10Z anueda@asic.upv.es $
 ***********************************************************************************
 *
 ...
 * @author Ed Smiley
 * @version $Id: EditAssessmentListener.java 306359 2014-02-25 07:49:10Z anueda@asic.upv.es $
 */
    ...
    implements ActionListener
{
  ...
  public void setPropertiesForAssessment(AuthorBean author) {
		...
		if (assessmentBean.getAssessment() == null || !assessmentId.equals(assessmentBean.getAssessmentId()) ||
				assessmentBean.getQuestionSize() == 0) {
		...
		*/
		...
		if (!passAuthz(context, assessmentBean.getAssessment().getCreatedBy())) {

/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-app/src/java/org/sakaiproject/tool/assessment/ui/bean/author/PublishedAssessmentSettingsBean.java $
 * $Id: PublishedAssessmentSettingsBean.java 321194 2015-09-15 07:24:24Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public class PublishedAssessmentSettingsBean
  ...
  public void setAssessment(PublishedAssessmentFacade assessment) {
    try {
      ...
      if (accessControl != null) {
  	  ...
  	  //CONDITIONAL RELEASE
      this.checkConditionalRelease = false;
	  if (accessControl.isUseConditionalRelease()!=null)
		this.checkConditionalRelease = accessControl.isUseConditionalRelease();
	  this.notificationId = null;
	  if (accessControl.getNotificationId()!=null)
		this.notificationId = accessControl.getNotificationId();
  ...
  protected void populateSelectedLists() {
	  ...
	  if(releaseTo.equals(AssessmentAccessControlIfc.RELEASE_TO_SELECTED_STUDENTS)){

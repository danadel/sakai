/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-app/src/java/org/sakaiproject/tool/assessment/ui/listener/author/EditPublishedSettingsListener.java $
 * $Id: EditPublishedSettingsListener.java 321489 2015-10-14 10:05:42Z anueda@asic.upv.es $
 ***********************************************************************************
 *
 ...
 * @author Ed Smiley
 * @version $Id: EditPublishedSettingsListener.java 321489 2015-10-14 10:05:42Z anueda@asic.upv.es $
 */
    ...
    implements ActionListener
{
  ...
  public void processAction(ActionEvent ae) throws AbortProcessingException
  {
	...
	//CR
    AssessmentConditionsHelper ach = new AssessmentConditionsHelper();
    Map<String,String> values = ach.loadConditionData(
    		SessionManager.getCurrentToolSession(), assessment.getAssessmentAccessControl().getNotificationId());
    
	assessmentSettings.setNotificationId(assessment.getAssessmentAccessControl().getNotificationId());
	Boolean condRelease = assessment.getAssessmentAccessControl().isUseConditionalRelease();
	assessmentSettings.setCheckConditionalRelease(condRelease == null ? false : condRelease.booleanValue());
		
	if (values == null) {
		assessmentSettings.setCheckConditionalRelease(false);
		
	} else {
		assessmentSettings.setSubmittedFunctionName(values.get("submittedFunctionName"));
		assessmentSettings.setGradebookItem(values.get("gradebookItem"));
		assessmentSettings.setConditionalOptionSelected(values.get("conditionalOptionSelected"));
		assessmentSettings.setConditionArgument(values.get("conditionArgument"));
	}

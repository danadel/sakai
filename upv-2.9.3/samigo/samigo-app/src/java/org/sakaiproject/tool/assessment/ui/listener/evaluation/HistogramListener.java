 ...
 *
 * @version $Id: HistogramListener.java 314945 2014-10-28 11:58:38Z anueda@asic.upv.es $
 */
  ...
  implements ActionListener, ValueChangeListener
{
  ...
  private PublishedAssessmentService pubService  =  new PublishedAssessmentService();
  ...
  public boolean histogramScores(HistogramScoresBean histogramScores, TotalScoresBean totalScores)
  {
    	...
    	publishedId = totalScores.getPublishedId();
    ...
    for (int i=0; i<array.length; i++)
{
    ...
    double min = 0;
    double max = ((PublishedAssessmentIfc) pubService.getPublishedAssessment(publishedId, false)).getTotalScore().doubleValue();

/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-app/src/java/org/sakaiproject/tool/assessment/ui/listener/author/RemoveAssessmentListener.java $
 * $Id: RemoveAssessmentListener.java 316693 2015-01-12 09:29:29Z anueda@asic.upv.es $
 ***********************************************************************************
 *
 ...
 * @author Ed Smiley
 * @version $Id: RemoveAssessmentListener.java 316693 2015-01-12 09:29:29Z anueda@asic.upv.es $
 */
...
public class RemoveAssessmentListener implements ActionListener
{
  ...
  public void processAction(ActionEvent ae) throws AbortProcessingException
  {
	...
	AssessmentFacade f = s.getAssessment(assessmentId);
	AssessmentAccessControlIfc accessControl = null;
	accessControl = f.getAssessmentAccessControl();

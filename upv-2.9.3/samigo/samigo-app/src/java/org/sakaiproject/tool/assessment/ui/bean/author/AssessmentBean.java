/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-app/src/java/org/sakaiproject/tool/assessment/ui/bean/author/AssessmentBean.java $
 * $Id: AssessmentBean.java 320223 2015-07-21 12:37:13Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public class AssessmentBean  implements Serializable {
   ...
   */
  public int getPoolSectionsSize()
  {
    if (sections == null)
    {
      return 0;
    ...
    for (SectionContentsBean sectionBean : (List<SectionContentsBean>)this.sections) {
        if (sectionBean.getPoolIdToBeDrawn() != null) {
        	numPoolSections++;
        }
    }
    return numPoolSections;
  }

/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-app/src/java/org/sakaiproject/tool/assessment/ui/listener/author/TemplateListener.java $
 * $Id: TemplateListener.java 131836 2013-11-21 16:31:37Z anueda@asic.upv.es $
 ***********************************************************************************
 *
  ...
  public void processAction(ActionEvent ae) throws AbortProcessingException
  {
	...
	ArrayList list = assessmentService.getBasicInfoOfAllActiveAssessmentTemplates("title");
	 ...
	 AssessmentTemplateFacade facade = (AssessmentTemplateFacade) iter.next();
         ...
         bean.setCreatedBy(facade.getCreatedBy());
         templates.add(bean);
        }
      } catch (Exception e) {
	e.printStackTrace();

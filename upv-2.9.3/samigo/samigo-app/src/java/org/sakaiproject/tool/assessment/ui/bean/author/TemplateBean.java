/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-app/src/java/org/sakaiproject/tool/assessment/ui/bean/author/TemplateBean.java $
 * $Id: TemplateBean.java 131836 2013-11-21 16:31:37Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public class TemplateBean implements Serializable
{
  ...
  public TemplateBean()
  {
    ...
    values.put("markForReview_isInstructorEditable", Boolean.TRUE);
    values.put("automaticSubmission_isInstructorEditable", Boolean.TRUE);
 ...
 */
 ...
 /**
  ...
  /**
   * @param blockDivs the blockDivs to set
   */
  ...
  public Boolean getIsMine() {
	  ...
	  if (createdBy != null && createdBy.equals(agent))
		  return true;
	  else
		  return false;
  }

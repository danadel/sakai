/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-app/src/java/org/sakaiproject/tool/assessment/ui/bean/author/AuthorBean.java $
 * $Id: AuthorBean.java 316693 2015-01-12 09:29:29Z anueda@asic.upv.es $
 ***********************************************************************************
 *
 ...
 * @author Ed Smiley
 *
 * @version $Id: AuthorBean.java 316693 2015-01-12 09:29:29Z anueda@asic.upv.es $
 */
public class AuthorBean implements Serializable
{
  ...
  private ArrayList<SelectItem> pendingActionList3;
  private ArrayList<SelectItem> publishedActionList;
  private ArrayList<SelectItem> publishedActionList2;
...
*/
 ...
 /**
  ...
  public ArrayList<SelectItem> getPendingSelectActionList3()
  {
	  if (pendingActionList3 != null) {
		  return pendingActionList3;
	  }
	  ResourceLoader res = new ResourceLoader("org.sakaiproject.tool.assessment.bundle.AuthorMessages");
	  AuthorizationBean authorizationBean = (AuthorizationBean) ContextUtil.lookupBean("authorization");

	  pendingActionList3 = new ArrayList<SelectItem>();
	  boolean isDeleteAnyAssessment = authorizationBean.getDeleteAnyAssessment();
	  boolean isDeleteOwnAssessment = authorizationBean.getDeleteOwnAssessment();

	  pendingActionList3.add(new SelectItem("select", res.getString("select_action")));
	  if (isDeleteAnyAssessment || isDeleteOwnAssessment) {
		  pendingActionList3.add(new SelectItem("restore_assessment", res.getString("action_restore")));
	  }
  ...
  public ArrayList<SelectItem> getPublishedSelectActionList2()
  {
	  if (publishedActionList2 != null) {
		  return publishedActionList2;
	  }
	  ResourceLoader res = new ResourceLoader("org.sakaiproject.tool.assessment.bundle.AuthorMessages");
	  AuthorizationBean authorizationBean = (AuthorizationBean) ContextUtil.lookupBean("authorization");

	  publishedActionList2 = new ArrayList<SelectItem>();
	  boolean isDeleteAnyAssessment = authorizationBean.getDeleteAnyAssessment();
	  boolean isDeleteOwnAssessment = authorizationBean.getDeleteOwnAssessment();

	  if (isDeleteAnyAssessment || isDeleteOwnAssessment) {
		  publishedActionList2.add(new SelectItem("restore_published", res.getString("action_restore")));
	  }

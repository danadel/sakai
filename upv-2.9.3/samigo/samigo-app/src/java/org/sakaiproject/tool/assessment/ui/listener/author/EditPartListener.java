/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-app/src/java/org/sakaiproject/tool/assessment/ui/listener/author/EditPartListener.java $
 * $Id: EditPartListener.java 133129 2014-01-09 15:10:24Z anueda@asic.upv.es $
 ***********************************************************************************
 *
 ...
 * @author Ed Smiley
 * @version $Id: EditPartListener.java 133129 2014-01-09 15:10:24Z anueda@asic.upv.es $
 */
    ...
    implements ActionListener
{
  ...
  public void processAction(ActionEvent ae) throws AbortProcessingException
  {
    ...
    if (isEditPendingAssessmentFlow) {
    	...
    	// Optimizar la búsqueda de la sección. Si ya se ha cargado completamente el examen simplemente localizamos la sección seleccionada
    	if (assessmentBean.getAssessment() != null && assessmentBean.getAssessment().getSectionSet() != null) {
        	Iterator iter = assessmentBean.getAssessment().getSectionSet().iterator();
        	while (iter.hasNext()) {
        		SectionFacade s = (SectionFacade)iter.next();
        		if (s.getSectionId().toString().equals(sectionId)) {
        			section = s;
        			break;
        		}
        	}
        }
        // Si no hemos cargado el examen con sus secciones, cargamos la seccion
        else {
    ...
    sectionBean.setNoOfItems(section.getItemSet() == null ? "0" : String.valueOf(section.getItemSet().size()));

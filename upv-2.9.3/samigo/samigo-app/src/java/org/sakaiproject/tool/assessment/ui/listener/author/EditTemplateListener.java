/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-app/src/java/org/sakaiproject/tool/assessment/ui/listener/author/EditTemplateListener.java $
 * $Id: EditTemplateListener.java 131473 2013-11-13 13:38:50Z anueda@asic.upv.es $
 ***********************************************************************************
 *
    ...
    extends TemplateBaseListener implements ActionListener
{
  ...
  private HashMap getMetaDataMap(){
    ...
    while (iter.hasNext()){
      ...
      String label = (String) metadata.getLabel();

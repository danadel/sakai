...
public class ActionSelectListener implements ValueChangeListener {
	...
	public void processValueChange(ValueChangeEvent ae)
		...
		else if ("restore_assessment".equals(newValue)) {
			RestoreAssessmentListener restoreAssessmentListener = new RestoreAssessmentListener();
			restoreAssessmentListener.processAction(null);
			author.setJustPublishedAnAssessment(false);
		...
		else if ("restore_published".equals(newValue)) {
			RestorePublishedAssessmentListener restorePublishedAssessmentListener = new RestorePublishedAssessmentListener();
			restorePublishedAssessmentListener.processAction(null);
			author.setJustPublishedAnAssessment(true);
			author.setOutcome("author");
		}
	}

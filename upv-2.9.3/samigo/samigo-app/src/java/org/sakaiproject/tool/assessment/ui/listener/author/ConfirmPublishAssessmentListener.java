/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-app/src/java/org/sakaiproject/tool/assessment/ui/listener/author/ConfirmPublishAssessmentListener.java $
 * $Id: ConfirmPublishAssessmentListener.java 317994 2015-03-16 08:11:55Z anueda@asic.upv.es $
 ***********************************************************************************
 *
 ...
 * @author Ed Smiley
 * @version $Id: ConfirmPublishAssessmentListener.java 317994 2015-03-16 08:11:55Z anueda@asic.upv.es $
 */
...
public class ConfirmPublishAssessmentListener
 ...
 // check if start date is valid
    ...
    if(assessmentSettings.getToDefaultGradebook() != null && 
    		(assessmentSettings.getToDefaultGradebook().equals(EvaluationModelIfc.TO_DEFAULT_GRADEBOOK.toString()) 
    				|| assessmentSettings.getToDefaultGradebook().equals(EvaluationModelIfc.TO_SELECTED_GRADEBOOK.toString())))
	{

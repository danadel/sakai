...
public class RetakeAssessmentListener implements ActionListener {
	...
	public void processAction(ActionEvent ae) throws AbortProcessingException {
		...
		EventTrackingService.post(
				EventTrackingService.newEvent("sam.assessment.allow_retake", "publishedAssessmentId=" + retakeAssessment.getPublishedAssessmentId() + ", agentId=" + retakeAssessment.getAgentId(), true));
	}

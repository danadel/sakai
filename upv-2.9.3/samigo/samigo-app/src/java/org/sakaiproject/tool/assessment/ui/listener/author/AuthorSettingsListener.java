/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-app/src/java/org/sakaiproject/tool/assessment/ui/listener/author/AuthorSettingsListener.java $
 * $Id: AuthorSettingsListener.java 321328 2015-09-25 07:50:37Z anueda@asic.upv.es $
 ***********************************************************************************
 *
 ...
 * @author Ed Smiley
 * @version $Id: AuthorSettingsListener.java 321328 2015-09-25 07:50:37Z anueda@asic.upv.es $
 */
...
public class AuthorSettingsListener implements ActionListener
{
  ...
  public void processAction(ActionEvent ae) throws AbortProcessingException
  {
	...
	//CR
	assessmentSettings.setCheckConditionalRelease(Boolean.valueOf(assessment.getAssessmentMetaDataByLabel(AssessmentMetaDataIfc.CR_CHECK)));
	assessmentSettings.setGradebookItem(assessment.getAssessmentMetaDataByLabel(AssessmentMetaDataIfc.CR_GRADEBOOK_ITEM));
	assessmentSettings.setConditionalOptionSelected(assessment.getAssessmentMetaDataByLabel(AssessmentMetaDataIfc.CR_OPTION_SELECTED));
	assessmentSettings.setConditionArgument(assessment.getAssessmentMetaDataByLabel(AssessmentMetaDataIfc.CR_ARGUMENT));
	
	AssessmentConditionsHelper ach = new AssessmentConditionsHelper();
	ach.loadConditionData(SessionManager.getCurrentToolSession(), null);

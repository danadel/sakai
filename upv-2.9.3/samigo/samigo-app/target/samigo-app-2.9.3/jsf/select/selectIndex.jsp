...
<!-- $Id: selectIndex.jsp 131875 2013-11-22 09:01:08Z anueda@asic.upv.es $
<%--
***********************************************************************************
*
...
--%>
  ...
  <h:dataTable cellpadding="0" cellspacing="0" id="selectTable" value="#{select.takeableAssessments}"
	...
	<h:outputText value="#{selectIndexMessages.no_time_limit}" styleClass="currentSort"  rendered="#{takeable.timeLimit_hour == 0 && takeable.timeLimit_minute == 0}"  escape="false"/>
...
<%-- TITLE --%>
	...
	<h:outputText value="#{selectIndexMessages.asterisk}" rendered="#{reviewable.isRecordedAssessment && !reviewable.isAssessmentRetractForEdit && reviewable.hasAssessmentBeenModified}" styleClass="validate"/> 

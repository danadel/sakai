...
<!-- $Id: templateEditor.jsp 132064 2013-12-02 11:00:04Z anueda@asic.upv.es $
<%--
***********************************************************************************
*
    ...
    <html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
      ...
      <script type="text/javascript">
        $(document).ready(function() {
            ...
            var blockDivs = document.forms[0].elements['templateEditorForm:blockDivs'].value;
            if (blockDivs != "") {
            	for (i=0 ; i < divElements.length; i++)
	            {
	            	if(divElements[i].id.indexOf("__hide_division_templateEditorForm") >=0)
	                {
        ...
        {  
           	...
           	{
        	   	if(blockElements[i].id.indexOf("__hide_division_templateEditorForm") >=0 && blockElements[i].style.display != "none")
              	{ 
                 	var id = blockElements[i].id.substring(35);
        	  	}
           	}
           	document.forms[0].elements['templateEditorForm:blockDivs'].value = id;
...
<!-- content... -->
 <div class="portletBody">
  <h:form id="templateEditorForm">
  	<h:inputHidden id="blockDivs" value="#{template.blockDivs}"/>
 ...
 <div class="tier2">
    ...
    <div class="tier3">
     <h:panelGrid columns="2" summary="#{templateMessages.question_layout_sub}">
       ...
       <h:outputText value=" "/>
       <h:panelGroup>
    <h:selectOneRadio id="assessmentFormat" layout="pageDirection" value="#{template.displayChunking}" 
    	required="true" rendered="#{template.itemAccessType!=1}">
      <f:selectItem itemValue="1"
    ...
    <h:selectOneRadio id="assessmentFormat2" layout="pageDirection" value="1" 
    	disabled="true" rendered="#{template.itemAccessType==1}">
      <f:selectItem itemValue="1"
        itemLabel="#{templateMessages.quest_sep_page}"/>
      <f:selectItem itemValue="2"
        itemLabel="#{templateMessages.part_sep_page}"/>

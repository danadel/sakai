...
<!--
$Id: gradeStudentResult.jsp 314021 2014-10-06 09:40:03Z anueda@asic.upv.es $
<%--
***********************************************************************************
*
...
<h:panelGroup rendered="#{totalScores.anonymous eq 'false' && studentScores.email != null && studentScores.email != '' && email.fromEmailAddress != null && email.fromEmailAddress != ''}">
  ...
  <h:outputText value="#{studentScores.email}', '#{totalScores.assessmentName} #{commonMessages.feedback}')\">" escape="false" />

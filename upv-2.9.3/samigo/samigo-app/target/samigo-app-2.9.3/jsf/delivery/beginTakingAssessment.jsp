...
<!--
* $Id: beginTakingAssessment.jsp 131732 2013-11-19 08:42:11Z anueda@asic.upv.es $
<%--
***********************************************************************************
*
...
<h:panelGrid columns="2" border="0">
	...
	<!-- NOTE about how configure audio recording questions -->
	<h:panelGroup rendered="#{delivery.hasAudioQuestions}" styleClass="validation">  
		<h:outputText value="#{deliveryMessages.note} "/>
		<h:outputText value="#{deliveryMessages.audio_question_instructions_1} "/>
		<h:outputLink value="#" title="#{deliveryMessages.audio_question_instructions_link}" onclick="javascript:window.open('#{delivery.audioQuestionInstruccions}','AudioRecordingInstructions','width=800,height=600,scrollbars=yes, resizable=yes');">
			<h:outputText value="#{deliveryMessages.audio_question_instructions_link} "/>
		</h:outputLink>
		<h:outputText value="#{deliveryMessages.audio_question_instructions_2} "/>

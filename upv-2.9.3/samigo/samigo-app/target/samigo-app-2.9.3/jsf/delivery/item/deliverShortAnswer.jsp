<%-- $Id: deliverShortAnswer.jsp 314216 2014-10-13 07:47:43Z anueda@asic.upv.es $
...
<h:panelGroup>
  <h:panelGrid rendered="#{question.modelAnswerIsNotEmpty}" >
    <h:panelGroup> 
  ...
  <h:panelGrid rendered="#{delivery.feedback eq 'true' && delivery.feedbackComponent.showItemLevel && !delivery.noFeedback=='true' && question.feedbackIsNotEmpty}">
    <h:panelGroup> 
  ...
  <h:panelGrid rendered="#{delivery.feedback eq 'true' && delivery.actionString !='gradeAssessment' && delivery.feedbackComponent.showGraderComment && !delivery.noFeedback=='true' && (question.gradingCommentIsNotEmpty || question.hasItemGradingAttachment)}" columns="1" border="0">  			   
    <h:panelGroup>  

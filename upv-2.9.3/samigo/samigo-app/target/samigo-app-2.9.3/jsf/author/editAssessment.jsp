...
<!--
* $Id: editAssessment.jsp 320223 2015-07-21 12:37:13Z anueda@asic.upv.es $
<%--
***********************************************************************************
*
...
<f:verbatim><div class="tier2"></f:verbatim>
		...
		<h:outputText rendered="#{partBean.sectionAuthorType!= null && partBean.sectionAuthorTypeString == '2' && empty partBean.randomQuestionsDrawDate && !author.isEditPoolFlow}" value="#{authorMessages.random_draw_msg_no_date}"/>
...
<h:panelGrid columns="1" width="100%" border="0">
	...
	<h:commandButton value="#{authorMessages.random_update_all_questions}" type="submit" id="randomAllQuestions" action="editAssessment" style="margin-left: 2em" 
		rendered="#{(assessmentBean.poolSectionsSize > 1 && author.isEditPendingAssessmentFlow)}">

...
<!--
* $Id: trueFalse.jsp 310284 2014-06-17 15:25:12Z anueda@asic.upv.es $
<%--
***********************************************************************************
*
...
<div class="shorttext">
    ...
    <h:inputText id="answerptr" value="#{itemauthor.currentItem.itemScore}" required="true" disabled="#{author.pointValueHasOverrided}" onchange="toPoint(this.id);">

...
<!--
/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-app/src/webapp/jsf/author/publishedSettings.jsp $
 * $Id: publishedSettings.jsp 314116 2014-10-08 09:58:30Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
-->
  <f:view>
    ...
    <body onload="reloadAllListsValues();<%= request.getAttribute("html.body.onload") %>">
...
<f:verbatim></div></f:verbatim>
  ...
  <f:verbatim><div class="tier2"></f:verbatim>
    <h:panelGrid   summary="#{templateMessages.released_to_info_sec}">
      <h:selectOneRadio layout="pagedirection" value="#{publishedSettings.firstTargetSelected}"
       onclick="showHideReleaseGroups();setBlockDivs();submitForm();">
  ...
  <f:verbatim></div></f:verbatim>
	...
	<f:verbatim><div id="groupAdhocDiv" class="tier3"></f:verbatim>
  	<h:panelGrid columns="3" style="margin-bottom:20px;" rendered="#{publishedSettings.hasAvailableGroups}">
		...
		<h:selectManyListbox style="width: 350px; height:200px;" id="groupList_available" ondblclick="move('assessmentSettingsAction:groupList_available','assessmentSettingsAction:groupList_selected', false);">  
			<f:selectItems  value="#{publishedSettings.groupList_available}"/>
		</h:selectManyListbox>	
		...
		<h:selectManyListbox style="width: 350px; height:200px;" id="groupList_selected" ondblclick="move('assessmentSettingsAction:groupList_selected','assessmentSettingsAction:groupList_available', false);">
			<f:selectItems  value="#{publishedSettings.groupList_selected}"/>  
		</h:selectManyListbox>
		
	</h:panelGrid>
	<h:inputHidden id="groupList_hidden" value="#{publishedSettings.serialized_groupList}" />
    <h:panelGrid columns="3">
		...
		<h:selectManyListbox style="width: 350px; height:200px;" id="userList_available" ondblclick="move('assessmentSettingsAction:userList_available','assessmentSettingsAction:userList_selected', false);">  
			<f:selectItems  value="#{publishedSettings.userList_available}"/>  
		</h:selectManyListbox>
		...
		<h:selectManyListbox style="width: 350px; height:200px;" id="userList_selected" ondblclick="move('assessmentSettingsAction:userList_selected','assessmentSettingsAction:userList_available', false);">
			<f:selectItems  value="#{publishedSettings.userList_selected}"/>  
		</h:selectManyListbox>				
   </h:panelGrid>
   <h:inputHidden id="userList_hidden" value="#{publishedSettings.serialized_userList}" />
   <f:verbatim></div></f:verbatim>
  ...
  <f:verbatim><div class="tier2"></f:verbatim>
   <h:panelGrid border="0" columns="2"
	...
	<h:selectBooleanCheckbox
         ...
         value="#{publishedSettings.checkConditionalRelease}"/>
	...
	<h:panelGrid border="0" columns="4" summary="Resumen" rendered="#{noGradebookItems==false}">
		...
		<h:selectOneMenu id="gradebookItem" value="#{publishedSettings.gradebookItem}" disabled="false">
          <f:selectItems value="#{resourceSelectionsSelectItems}" />
		</h:selectOneMenu>
		<h:selectOneMenu id="conditionalOptionSelected" value="#{publishedSettings.conditionalOptionSelected}" onchange="getAllListValue();setBlockDivs();document.forms[0].onsubmit();document.forms[0].submit();" disabled="false">
          <f:selectItems value="#{conditionSelectionsSelectItems}" />
		</h:selectOneMenu>
		<h:inputText id="conditionArgument" size="4" value="#{publishedSettings.conditionArgument}" rendered="#{publishedSettings.renderConditionArgument == true}" />
	</h:panelGrid>
  ...
  <samigo:hideDivision title="#{assessmentSettingsMessages.t_highSecurity}" id="div4">
    ...
    <h:panelGrid border="0" columns="2" columnClasses="longtext"
	  ...
	  <h:panelGrid border="0" columns="1"  columnClasses="longtext"
		rendered="#{publishedSettings.valueMap.lockedBrowser_isInstructorEditable==true && publishedSettings.secureDeliveryAvailable}">
	    <h:selectOneRadio id="secureDeliveryModule" value="#{publishedSettings.secureDeliveryModule}"  layout="pageDirection" onclick="getAllListValue();setBlockDivs();document.forms[0].onsubmit();document.forms[0].submit();">
  ...
  <f:verbatim></div></f:verbatim>
    ...
    <h:panelGroup>
      ...
      <h:panelGrid columns="1" rendered="#{publishedSettings.valueMap.feedbackType_isInstructorEditable==true}" >
	    ...
	    <h:panelGrid columns="7" rendered="#{publishedSettings.valueMap.feedbackAuthoring_isInstructorEditable==true}">
		  <h:outputText value=" "/>
		  <h:outputText value=" "/>
		  <h:outputText value=" "/>
		  <h:outputText value=" "/>
	 ...
	 <f:verbatim></div><div class="tier3"></f:verbatim>
      <h:panelGrid columns="2" rendered="#{publishedSettings.firstTargetSelected != 'Anonymous Users'}">
        <h:selectOneRadio id="toDefaultGradebook1"
            value="#{publishedSettings.toDefaultGradebook}"  layout="pageDirection" onclick="getAllListValue();setBlockDivs(); submitForm();">
      ...
      <h:panelGrid columns="2" rendered="#{publishedSettings.firstTargetSelected != 'Anonymous Users' && publishedSettings.toDefaultGradebook == 3}">
      	<h:selectOneMenu id="toGradebook" value="#{publishedSettings.gradebookName}" >
...
<p class="act">
  ...
  <!-- Save button -->
  <h:commandButton type="submit" value="#{assessmentSettingsMessages.button_save_settings}" action="#{publishedSettings.getOutcome}"  styleClass="active" onclick="getAllListValue();setBlockDivs();updateItemNavigation(false);" >

...
public class BaseConditionServiceSam implements ConditionService, Observer {

	private static Log log = LogFactory.getLog(BaseConditionServiceSam.class);
	...
	public Rule makeRule(String resourceId, List<Condition> predicates,
			Conjunction or) {
		return new AssessmentReleaseRule(resourceId, predicates, Rule.Conjunction.OR);
	}

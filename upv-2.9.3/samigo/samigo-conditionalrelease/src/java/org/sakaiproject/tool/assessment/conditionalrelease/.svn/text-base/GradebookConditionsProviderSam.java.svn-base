...
public class GradebookConditionsProviderSam implements ConditionProvider {
	...
	public void init() {
		eventLookup.put("gradebook.updateItemScore", "org.sakaiproject.tool.assessment.conditionalrelease.AssignmentGrading");
		eventLookup.put("gradebook.updateAssignment", "org.sakaiproject.tool.assessment.conditionalrelease.AssignmentUpdate");

/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/samigo/samigo-api/src/java/org/sakaiproject/tool/assessment/data/ifc/assessment/AssessmentAccessControlIfc.java $
 * $Id: AssessmentAccessControlIfc.java 131815 2013-11-21 09:22:46Z anueda@asic.upv.es $
 ***********************************************************************************
 *
    ...
    extends java.io.Serializable
{
  ...
  public static String RELEASE_TO_SELECTED_STUDENTS = "Assign Students";
  ...
  Boolean isUseConditionalRelease();
  
  void setUseConditionalRelease(Boolean useConditionalRelease);
  
  String getNotificationId();
  
  void setNotificationId(String notificationId);
  
  Boolean isSatisfiesRule();
  
  void setSatisfiesRule(Boolean satisfiesRule);
  
  String getConditionalAccessList();
  
  void setConditionalAccessList(String conditionalAccessList);

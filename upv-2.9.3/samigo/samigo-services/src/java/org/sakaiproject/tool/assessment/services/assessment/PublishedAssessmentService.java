...
*/
  ...
  public PublishedAssessmentFacade restorePublishedAssessment(Long assessmentId, String newTitle) {
	  PublishedAssessmentFacade restored = PersistenceService.getInstance().getPublishedAssessmentFacadeQueries().
 ...
 public boolean publishedAssessmentTitleIsUnique(String assessmentBaseId, String title) {
  ...
  public boolean isRandomDrawPart(Long publishedAssessmentId, Long publishedSectionId){
   ...
   public Integer getNumberPublishedBasedAssessment(Long assessmentId) {
	   return PersistenceService.getInstance().
			   getPublishedAssessmentFacadeQueries().getNumberPublishedBasedAssessment(assessmentId);
   }
}

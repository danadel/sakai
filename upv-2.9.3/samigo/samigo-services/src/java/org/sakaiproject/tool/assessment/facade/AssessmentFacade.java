    ...
    implements java.io.Serializable, AssessmentIfc
{
  ...
  private boolean publishedForDisplay;
  ...
  public AssessmentFacade(Long id, String title, Integer status, Date lastModifiedDate, String lastModifiedBy, int questionSize) {
	    // in the case of template assessmentBaseId is the assessmentTemplateId
	    super.setAssessmentBaseId(id);
	    super.setTitle(title);
  ...
  public boolean getPublishedForDisplay() {
	  return this.publishedForDisplay;
  }
	    
  public void setPublishedForDisplay(boolean publishedForDisplay) {
	  this.publishedForDisplay = publishedForDisplay;
  }
}

...
*/
  ...
  public ItemData cloneItem(ItemDataIfc item){
    ItemData cloned= new ItemData(
        ...
        null, null, null, null, item.getTriesAllowed(), item.getPartialCreditFlag());
  ...
  private Set<ItemHistoricalIfc> copyItemHistoricalSet(ItemData cloned, Set<ItemHistoricalIfc> itemHistoricalSet) {
    HashSet h = new HashSet();
    if (itemHistoricalSet != null) {
	    Iterator<ItemHistoricalIfc> n = itemHistoricalSet.iterator();
	    while (n.hasNext()) {
	    	ItemHistoricalIfc itemHistorical = n.next();
	      ItemHistoricalIfc newItemHistorical = new ItemHistorical(
	          cloned, itemHistorical.getModifiedBy(), itemHistorical.getModifiedDate());

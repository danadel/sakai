...
public interface AssessmentFacadeQueriesAPI {
	...
	public ArrayList getBasicInfoOfAllAssessmentsByAgent(boolean onlyActives, String orderBy,
	...
	public ArrayList getTemplatesShared(Long templateId, String ownerId);

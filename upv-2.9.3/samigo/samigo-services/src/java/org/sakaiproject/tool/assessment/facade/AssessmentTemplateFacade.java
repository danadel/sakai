/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/sam/trunk/component/src/java/org/sakaiproject/tool/assessment/facade/AssessmentTemplateFacade.java $
 * $Id: AssessmentTemplateFacade.java 9273 2006-05-10 22:34:28Z daisyf@stanford.edu $
 ***********************************************************************************
 *
    ...
    implements java.io.Serializable, AssessmentTemplateIfc
{
   ...
   */
  public AssessmentTemplateFacade(Long id, String title, Date lastModifiedDate, Long typeId, String createdBy) {
    // in the case of template assessmentBaseId is the assessmentTemplateId
    this.assessmentTemplateId = id;
    super.setAssessmentBaseId(id);
    super.setTitle(title);

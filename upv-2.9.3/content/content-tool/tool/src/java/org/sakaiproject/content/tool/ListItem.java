/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/content/content-tool/tool/src/java/org/sakaiproject/content/tool/ListItem.java $
 * $Id: ListItem.java 306591 2014-02-28 12:41:53Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public class ListItem
{
	...
	public static ListItem getListItem(ContentEntity entity, ListItem parent, ResourceTypeRegistry registry, boolean expandAll, Set<String> expandedFolders, List<String> items_to_be_moved, List<String> items_to_be_copied, int depth, Comparator userSelectedSort, boolean preventPublicDisplay, ContentResourceFilter addFilter)
	{
        ...
        item.setCanImprimirReprografiaAction(ResourcesAction.getCanImprimirReprografiaAction(entity));
                
        item.setCanSendReprografiaAction(ResourcesAction.getCanSendReprografiaAction(entity));
	...
	protected boolean canImprimirReprografiaAction = false;
		
	protected boolean canSendReprografiaAction = false;
...
//		}
	...
	/**
	 * @return the canImprimirReprografiaAction
	 */
	public boolean getCanImprimirReprografiaAction() {
		return canImprimirReprografiaAction;
	}
		
	/**
	 * @param canImprimirReprografiaAction the canImprimirReprografiaAction to set
	 */
	public void setCanImprimirReprografiaAction(boolean canImprimirReprografiaAction) {
		this.canImprimirReprografiaAction = canImprimirReprografiaAction;
	}
		
	/**
	 * @return the canSendReprografiaAction
	 */
	public boolean getCanSendReprografiaAction() {
		return canSendReprografiaAction;
	}
		
	/**
	 * @param canSendReprografiaAction the canSendReprografiaAction to set
	 */
	public void setCanSendReprografiaAction(boolean canSendReprografiaAction) {
		this.canSendReprografiaAction = canSendReprografiaAction;
	}

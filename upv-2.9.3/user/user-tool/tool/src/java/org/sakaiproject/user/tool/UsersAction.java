/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/user/user-tool/tool/src/java/org/sakaiproject/user/tool/UsersAction.java $
 * $Id: UsersAction.java 132509 2013-12-12 09:05:38Z vacercon@upvnet.upv.es $
 ***********************************************************************************
 *
...
public class UsersAction extends PagedResourceActionII
{
	...
	private boolean readUserForm(RunData data, SessionState state)
	{
      ...
      if (!SecurityService.isSuperUser()) {
    	//SAK-21180
    	  	//Check if user has permission to update his/her password
    	  	if(UserDirectoryService.getInstance().allowUpdateUserPassword(user.getId())){

<%--
  ~ *********************************************************************************
  ~  $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/metaobj/metaobj-tool/tool/src/webapp/WEB-INF/jsp/confirmStructuredArtifactDefDelete.jsp $

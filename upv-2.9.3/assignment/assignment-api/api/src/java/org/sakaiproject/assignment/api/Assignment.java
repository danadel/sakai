/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/assignment/assignment-api/api/src/java/org/sakaiproject/assignment/api/Assignment.java $
 * $Id: Assignment.java 131234 2013-11-05 10:28:27Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public interface Assignment extends Entity, Comparable
{
	...
	/** Audio only assignment type. Samoo S.L. */
	public static final int AUDIO_ONLY_ASSIGNMENT_SUBMISSION = 6;
	
	/** Text and Audio assignment type. Samoo S.L. */
	public static final int TEXT_AND_AUDIO_ASSIGNMENT_SUBMISSION = 7;
	
	public static final int[] SUBMISSION_TYPES = {TEXT_ONLY_ASSIGNMENT_SUBMISSION,ATTACHMENT_ONLY_ASSIGNMENT_SUBMISSION, SINGLE_ATTACHMENT_SUBMISSION, TEXT_AND_ATTACHMENT_ASSIGNMENT_SUBMISSION,NON_ELECTRONIC_ASSIGNMENT_SUBMISSION,AUDIO_ONLY_ASSIGNMENT_SUBMISSION,TEXT_AND_AUDIO_ASSIGNMENT_SUBMISSION};

...
/* Conditional assignment release settings */
function changeCondition(selectValue)
{
	selectIndex = Number(selectValue.substring(0, selectValue.indexOf("|")));
	if (selectIndex < 9) {
		document.getElementById("grade_argument_span").style.display = "none";
	} else if (selectIndex < 11){
		document.getElementById("grade_argument_span").style.display = "inline";
	}
}

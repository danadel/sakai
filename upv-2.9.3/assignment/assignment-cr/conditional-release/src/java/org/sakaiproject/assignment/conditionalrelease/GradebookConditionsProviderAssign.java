...
public class GradebookConditionsProviderAssign implements ConditionProvider {
	...
	public void init() {
		eventLookup.put("gradebook.updateItemScore", "org.sakaiproject.assignment.conditionalrelease.AssignmentGrading");
		eventLookup.put("gradebook.updateAssignment", "org.sakaiproject.assignment.conditionalrelease.AssignmentUpdate");
	...
	public Map<String, String> getEntitiesForContext(String gradebookUid) {
		...
		for (Assignment asn : assignments) {
			...
			//rv.put("/gradebook/"+ gradebookUid + "/" + assignmentName.replace("/","__") + "/" + assignmentPoints + "/" + dueDateMillis + "/" + isReleasedToStudents + "/" + isUsedInGradeCalculation , assignmentName + " (" + assignmentPoints + " points)");

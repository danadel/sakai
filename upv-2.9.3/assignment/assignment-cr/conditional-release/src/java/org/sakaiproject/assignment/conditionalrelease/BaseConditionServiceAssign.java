/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/kernel/tags/kernel-1.2.1/kernel-impl/src/main/java/org/sakaiproject/conditions/impl/BaseConditionService.java $
 * $Id: BaseConditionService.java 81604 2010-08-21 14:17:52Z stephen.marquard@uct.ac.za $
 ***********************************************************************************
 *
...
public class BaseConditionServiceAssign implements ConditionService, Observer {

	private static Log log = LogFactory.getLog(BaseConditionServiceAssign.class);
	...
	public Rule makeRule(String resourceId, List<Condition> predicates,
			Conjunction or) {
		return new AssignmentReleaseRule(resourceId, predicates, Rule.Conjunction.OR);
	}

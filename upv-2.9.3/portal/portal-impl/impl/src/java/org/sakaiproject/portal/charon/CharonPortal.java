/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/portal/portal-impl/impl/src/java/org/sakaiproject/portal/charon/CharonPortal.java $
 * $Id: CharonPortal.java 130933 2013-10-29 07:00:31Z rmengod@cc.upv.es $
 ***********************************************************************************
 *
...
public class CharonPortal extends HttpServlet 
{
			...
			String siteId) throws IOException
	{
		...
		out.println("		<a href=\"http://www.upv.es\"><img title=\"Logo\" alt=\"Logo\" src=\"" + logo + "\" /></a>");
		out.println("	</div>");

/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/portal/portal-impl/impl/src/java/org/sakaiproject/portal/charon/SkinnableCharonPortal.java $
 * $Id: SkinnableCharonPortal.java 319838 2015-06-16 14:13:43Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public class SkinnableCharonPortal extends HttpServlet implements Portal
{
			...
			Session session, String returnPath) throws ToolException
	{
		...
		if ( returnPath != null ) 
		{
			//UPV Modificación para devolveruna URL distinta al ser PDA
			if ( returnPath.equals("/pda")) {
				loggedOutUrl = ServerConfigurationService.getString("loggedOutUrlMobile", "/portal/pda");
			}
			else {

/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/calendar/calendar-summary-tool/tool/src/java/org/sakaiproject/tool/summarycalendar/ui/CalendarBean.java $
 * $Id: CalendarBean.java 132546 2013-12-13 10:59:35Z vacercon@upvnet.upv.es $
 ***********************************************************************************
 *
...
//	}
	...
	public synchronized Map<String, String> getEventImageMap() {
		if(eventImageMap == null || eventImageMap.size() == 0){
			...
			eventImageMap.put("Teletutoria", imgLocation + "group.gif");
		}

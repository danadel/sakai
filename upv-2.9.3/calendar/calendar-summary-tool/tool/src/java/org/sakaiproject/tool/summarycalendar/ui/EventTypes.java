/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/calendar/calendar-summary-tool/tool/src/java/org/sakaiproject/tool/summarycalendar/ui/EventTypes.java $
 * $Id: EventTypes.java 132546 2013-12-13 10:59:35Z vacercon@upvnet.upv.es $
 ***********************************************************************************
 *
...
public class EventTypes {
	...
	public static void reloadLocalization() {
		...
		eventTypesToLocalized.put("Teletutoria", msgs.getString("legend.key17"));
	}

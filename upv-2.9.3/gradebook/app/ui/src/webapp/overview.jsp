      ...
      columnClasses="attach,left,center,center,center,center,center,center,center,external,center"
        	...
        	<t:commandSortHeader columnName="gradeEditor" propertyName="gradeEditor" immediate="true" arrow="true">
          	<h:outputText value="#{msgs.overview_grade_editor}" />
				...
				<h:outputText value="#{msgs.overview_from} " rendered="#{gradebookItem.assignment && ! empty gradebookItem.externalAppName}"/>
				<h:outputText value="#{gradebookItem.externalAppName}" rendered="#{gradebookItem.assignment}">
					<f:converter converterId="org.sakaiproject.gradebook.jsf.converter.EXTERNAL_APP_NAME_CONVERTER" />
				</h:outputText>
			</h:column>

/**********************************************************************************
*
* $Id: CourseGradesToSpreadsheetConverterDefault.java 132046 2013-11-29 13:47:53Z vacercon@upvnet.upv.es $
*
***********************************************************************************
*
...
public class CourseGradesToSpreadsheetConverterDefault implements CourseGradesToSpreadsheetConverter {
	...
	public List<List<Object>> getSpreadsheetData(
        ...
        headerRow.add(FacesUtil.getLocalizedString("course_grade_details_course_grade_column_value"));
        ...
        for (Object enrollment : enrollments) {
        	...
        	if (studentMap != null) {
    			...
    			if (gradeRecord != null) {
    				...
    				gradePoints = gradeRecord.getAutoCalculatedGrade();
    			}
        	}
        	row.add(grade);
        	row.add(gradePoints);

 /**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/announcement/announcement-tool/tool/src/java/org/sakaiproject/announcement/tool/AnnouncementAction.java $
 * $Id: AnnouncementAction.java 131528 2013-11-14 10:57:08Z vacercon@upvnet.upv.es $
 ***********************************************************************************
 *
			...
			if (AnnouncementService.allowGetChannel(channelId) && isOkayToDisplayMessageMenu(state))
			{
						...
						&& !state.getCurrentSortedBy().equals(SORT_GROUPDESCRIPTION))
				{
                  ...
                  if (view.equals(VIEW_MODE_ALL))
					...
					sstate.setAttribute(STATE_CURRENT_SORTED_BY, currentSortedBy);
	...
	private class AnnouncementComparator implements Comparator
	{
		...
		public int compare(Object o1, Object o2)
		{
			...
			else if (m_criteria.equals(SORT_RELEASEDATE))
			{
				...
				else // If both are null, then we order by date
				{
					//date is modified date
					Time o1ModDate = null;
					Time o2ModDate = null;

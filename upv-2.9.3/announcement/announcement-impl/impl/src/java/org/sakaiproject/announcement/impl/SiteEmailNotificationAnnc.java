/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/announcement/announcement-impl/impl/src/java/org/sakaiproject/announcement/impl/SiteEmailNotificationAnnc.java $
 * $Id: SiteEmailNotificationAnnc.java 313971 2014-10-01 10:04:43Z anueda@asic.upv.es $
 ***********************************************************************************
 *
				...
				implements ScheduledInvocationCommand
{
	...
	public void execute(String opaqueContext) 
	{
		...
		EventTrackingService.post(delayedNotificationEvent);

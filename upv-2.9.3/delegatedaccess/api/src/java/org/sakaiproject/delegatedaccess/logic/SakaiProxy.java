...
public interface SakaiProxy {
	...
	/**
	 * If this is set to true, the column Shopping admin will be hidden
	 * @return
	 */
	public boolean isHideShoppingColumn();
	
	/**
	 * If this is set to true, the column Advanced admin will be hidden
	 * @return
	 */
	public boolean isHideAdvancedColumn();
	
	/**
	 * If this is set to true, the column Restricted Tools admin will be hidden
	 * @return
	 */

...
public class DelegatedAccessConstants {
	...
	public static final String PROPERTIES_SHOPPING_HIDE_COLUMN = "delegatedaccess.disable.shopping";
	public static final String PROPERTIES_RESTRICTEDTOOLS_HIDE_COLUMN = "delegatedaccess.disable.restrictedTools";
	public static final String PROPERTIES_ADVANCED_HIDE_COLUMN = "delegatedaccess.disable.advanced";

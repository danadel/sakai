...
public class SakaiProxyImpl implements SakaiProxy {
   ...
   public List<Site> getAllSitesByPages(Map<String, String> propsMap, int page, int pageMax, boolean orderByModifiedDate){
	...
	public boolean isHideShoppingColumn() {
		return serverConfigurationService.getBoolean(DelegatedAccessConstants.PROPERTIES_SHOPPING_HIDE_COLUMN, false);
	}
	
	public boolean isHideAdvancedColumn() {
		return serverConfigurationService.getBoolean(DelegatedAccessConstants.PROPERTIES_ADVANCED_HIDE_COLUMN, false);
	}
	
	public boolean isHideRestrictedToolsColumn() {
		return serverConfigurationService.getBoolean(DelegatedAccessConstants.PROPERTIES_RESTRICTEDTOOLS_HIDE_COLUMN, false);
	}
}
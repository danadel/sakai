 ...
 */
            ...
            /**
            *  GetErrorByCodeResponse bean class
            */
        
        public  class GetErrorByCodeResponse
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected org.sakaiproject.videoconference.openmeetings.service.app.data.beans.basic.xsd.ErrorResult local_return ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return org.sakaiproject.videoconference.openmeetings.service.app.data.beans.basic.xsd.ErrorResult
                           */
                           public  org.sakaiproject.videoconference.openmeetings.service.app.data.beans.basic.xsd.ErrorResult get_return(){
                               return local_return;
                           }
                            ...
                            /**
                               ...
                               * @param param _return
                               */
                               public void set_return(org.sakaiproject.videoconference.openmeetings.service.app.data.beans.basic.xsd.ErrorResult param){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getErrorByCodeResponse".equals(type)){
                                ...
                                return (GetErrorByCodeResponse)org.sakaiproject.videoconference.openmeetings.service.app.hibernate.beans.basic.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.set_return(org.sakaiproject.videoconference.openmeetings.service.app.data.beans.basic.xsd.ErrorResult.Factory.parse(reader));

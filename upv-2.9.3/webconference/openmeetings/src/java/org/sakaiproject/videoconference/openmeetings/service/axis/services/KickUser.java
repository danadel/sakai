 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.lang.String localSID_Admin ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localSID_AdminTracker = false ;
                           ...
                           */
                           public  java.lang.String getSID_Admin(){
                               return localSID_Admin;
                           }
                            ...
                            /**
                               ...
                               * @param param SID_Admin
                               */
                               public void setSID_Admin(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localSID_AdminTracker = true;
                                       } else {
                                          localSID_AdminTracker = true;
                                              
                                       }
                                   
                                            this.localSID_Admin=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       KickUser.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                ...
                if (localSID_AdminTracker){
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"SID_Admin", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"SID_Admin");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("SID_Admin");
                                    }
                                

                                          if (localSID_Admin==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localSID_Admin);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localSID_AdminTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://services.axis.openmeetings.org",
                                         ...
                                         elementList.add(localSID_Admin==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSID_Admin));
                                    } if (localRoom_idTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://services.axis.openmeetings.org",
                                                                      "room_id"));
    ...
    public static class Factory{
        ...
        */
        public static KickUser parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            KickUser object =
                new KickUser();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"kickUser".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (KickUser)org.sakaiproject.videoconference.openmeetings.service.app.data.beans.basic.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.axis.openmeetings.org","SID_Admin").equals(reader.getName())){

 ...
 */
            ...
            /**
            *  GetRoomIdByExternalId bean class
            */
        
        public  class GetRoomIdByExternalId
                               ...
                               */
                               public void setExternalRoomId(long param){
                                       ...
                                       // setting primitive attribute tracker to true
                                               ...
                                               if (param==java.lang.Long.MIN_VALUE) {
                                           localExternalRoomIdTracker = false;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetRoomIdByExternalId.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getRoomIdByExternalId",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getRoomIdByExternalId",
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        xmlWriter.writeStartElement("externalRoomId");
                                               ...
                                               if (localExternalRoomId==java.lang.Long.MIN_VALUE) {
                                                         ...
                                                         throw new org.apache.axis2.databinding.ADBException("externalRoomId cannot be null!!");
    ...
    public static class Factory{
        ...
        */
        public static GetRoomIdByExternalId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetRoomIdByExternalId object =
                new GetRoomIdByExternalId();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getRoomIdByExternalId".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetRoomIdByExternalId)org.sakaiproject.videoconference.openmeetings.service.app.data.beans.basic.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.axis.openmeetings.org","externalRoomId").equals(reader.getName())){

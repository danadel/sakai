 ...
 */
            ...
            /**
            *  GetUsersByOrganisation bean class
            */
        
        public  class GetUsersByOrganisation
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getUsersByOrganisation".equals(type)){
                                ...
                                return (GetUsersByOrganisation)org.sakaiproject.videoconference.openmeetings.service.app.hibernate.beans.basic.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

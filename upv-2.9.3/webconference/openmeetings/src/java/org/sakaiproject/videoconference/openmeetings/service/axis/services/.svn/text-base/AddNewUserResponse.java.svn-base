                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addNewUserResponse".equals(type)){
                                ...
                                return (AddNewUserResponse)org.sakaiproject.videoconference.openmeetings.service.app.hibernate.beans.basic.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

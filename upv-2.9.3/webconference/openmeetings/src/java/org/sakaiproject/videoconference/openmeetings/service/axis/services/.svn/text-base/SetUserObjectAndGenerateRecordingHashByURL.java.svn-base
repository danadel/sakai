...
/**
 * SetUserObjectAndGenerateRecordingHashByURL.java
 *
 ...
 */
            ...
            /**
            *  SetUserObjectAndGenerateRecordingHashByURL bean class
            */
        
        public  class SetUserObjectAndGenerateRecordingHashByURL
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setUserObjectAndGenerateRecordingHashByURL".equals(type)){
                                ...
                                return (SetUserObjectAndGenerateRecordingHashByURL)org.sakaiproject.videoconference.openmeetings.service.app.hibernate.beans.basic.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

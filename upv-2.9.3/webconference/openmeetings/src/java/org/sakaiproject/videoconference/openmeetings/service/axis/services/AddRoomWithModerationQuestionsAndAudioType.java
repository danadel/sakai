...
/**
 * AddRoomWithModerationQuestionsAndAudioType.java
 *
 ...
 */
            ...
            /**
            *  AddRoomWithModerationQuestionsAndAudioType bean class
            */
        
        public  class AddRoomWithModerationQuestionsAndAudioType
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       AddRoomWithModerationQuestionsAndAudioType.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":addRoomWithModerationQuestionsAndAudioType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "addRoomWithModerationQuestionsAndAudioType",
    ...
    public static class Factory{
        ...
        */
        public static AddRoomWithModerationQuestionsAndAudioType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddRoomWithModerationQuestionsAndAudioType object =
                new AddRoomWithModerationQuestionsAndAudioType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addRoomWithModerationQuestionsAndAudioType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddRoomWithModerationQuestionsAndAudioType)org.sakaiproject.videoconference.openmeetings.service.app.data.beans.basic.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

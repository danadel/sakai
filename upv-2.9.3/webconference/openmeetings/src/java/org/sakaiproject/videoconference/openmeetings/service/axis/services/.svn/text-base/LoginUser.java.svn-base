                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"loginUser".equals(type)){
                                ...
                                return (LoginUser)org.sakaiproject.videoconference.openmeetings.service.app.hibernate.beans.basic.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

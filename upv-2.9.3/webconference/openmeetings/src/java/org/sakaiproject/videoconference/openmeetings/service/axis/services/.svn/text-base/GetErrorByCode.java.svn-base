 ...
 */
            ...
            /**
            *  GetErrorByCode bean class
            */
        
        public  class GetErrorByCode
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getErrorByCode".equals(type)){
                                ...
                                return (GetErrorByCode)org.sakaiproject.videoconference.openmeetings.service.app.hibernate.beans.basic.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

...
<f:view>
	...
	<sakai:view_container title="#{msgs.title_videoconferenceAddRoom}">
		...
		<script type="text/javascript" src="/adobeconnect-tool/js/jquery.picklist.js"></script>
			...
			<h:form id="addUpdateRoom">
				...
				<sakai:messages />
			 	...
			 	<sakai:panel_edit>
					...
					<h:outputText value="#{msgs.room_type}" styleClass="panelCell" rendered="#{VideoconferenceBean.typeOptions != null}"/>
			 		<h:selectOneMenu id="chooseType" value="#{VideoconferenceBean.currentRoom.room.type}" rendered="#{VideoconferenceBean.typeOptions != null}" >
					...
					<h:panelGroup styleClass="panelCell">					
						<rich:calendar value="#{VideoconferenceBean.currentRoom.room.startDate}"
							...
							timeZone="#{VideoconferenceBean.userTimeZone}"
				...
				<fieldset class="recurrencePanel">
					...
					<h:panelGroup style="margin-bottom: 20px; display:block;">
						<h:selectBooleanCheckbox id="publicOptions" value="#{VideoconferenceBean.currentRoom.room.public}"/>
						<h:outputLabel for="publicOptions">
						     <h:outputText value="#{msgs.public_room}" />
						</h:outputLabel>
					</h:panelGroup>				

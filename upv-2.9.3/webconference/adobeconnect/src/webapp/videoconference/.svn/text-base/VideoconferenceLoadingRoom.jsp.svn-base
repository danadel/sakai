...
<f:view>		
	...
	<script language="javascript">
		var videoUrl = "<h:outputText value="#{VideoconferenceBean.url}" escape="false"/>";
		var w = window.open(videoUrl,'Videoconference','resizable=yes,toolbar=no,scrollbars=yes, width=800,height=600');

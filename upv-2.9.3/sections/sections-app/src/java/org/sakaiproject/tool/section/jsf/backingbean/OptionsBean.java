/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/sections/sections-app/src/java/org/sakaiproject/tool/section/jsf/backingbean/OptionsBean.java $
 * $Id: OptionsBean.java 132280 2013-12-05 13:55:51Z vacercon@upvnet.upv.es $
 ***********************************************************************************
 *
	...
	public String update(boolean checkForConfirmation) {
		...
		if(INTERNAL.equals(management) || management == null) {
			...
			getSectionManager().setOpenDate(courseUuid,openDate);
                        //Informar al usuario de que debe seleccionar la opciÃ³n para que los estudiantes puedan asignarse a los grupos

 ...
 * $Id: CancelMeetingEmail.java 80643 2012-07-06 02:55:52Z steve.swinsburg@gmail.com $
***********************************************************************************
 *
...
public class CancelMeetingEmail extends SignupEmailBase {
	...
	public String getSubject() {
		return MessageFormat.format(rb.getString("subject.meeting.cancel.field"), new Object[] { meeting.getTitle(), getSiteTitle(this.emailReturnSiteId)});
	}
}

/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/kernel/kernel-util/src/main/java/org/sakaiproject/memory/util/EhCacheFactoryBean.java $
 * $Id: EhCacheFactoryBean.java 306796 2014-03-05 11:57:20Z rmengod@cc.upv.es $
 ***********************************************************************************
 *
	...
	public void afterPropertiesSet() throws CacheException, IOException {
		...
		if (this.cacheManager.cacheExists(this.cacheName)) {
            ...
            if (config != null && config.length() > 0) { 
                   logger.info("Found configuration for cache: "+ this.cacheName+ " of: "+ config); 

/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/kernel/api/src/main/java/org/sakaiproject/site/api/Site.java $
 * $Id: Site.java 131950 2013-11-26 15:17:37Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public interface Site extends Edit, Comparable, Serializable, AuthzGroup
{
	...
	/**
	 * property name for epigrafe
	 */
	public final static String PROP_SITE_EPIGRAFE = "epigrafe";
	...
	/**
	 * Get a collection of the active groups in a Site.
	 * 
	...
	/**
	 * Get a collection of all the groups in a Site.
	 * 
	 * @return A collection (Group) of all the groups defined in the site, empty if there are none.
	 */
	Collection<Group> getAllGroups();
		
	/**
	 * Get a collection of the groups to be deleted in a Site.
	 * 
	 * @return A collection (Group) of all the groups to be deleted in the site, empty if there are none.
	 */
	Collection<Group> getDeletedGroups();
		
	/**
	 * Get a collection of the inactive groups in a Site.
	 * 
	 * @return A collection (Group) of the inactive groups in the site, empty if there are none.
	 */
	Collection<Group> getInactiveGroups();
		
	/**
	 * Actives the lazy variable. It should only be used by SectionManagerImpl.
	 */
	void setLazy();
		
	/**
	 * It loads the site group properties when needed.
	 */
	void setSiteGroupProperties();

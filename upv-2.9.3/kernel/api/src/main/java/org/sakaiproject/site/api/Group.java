/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/kernel/api/src/main/java/org/sakaiproject/site/api/Group.java $
 * $Id: Group.java 131950 2013-11-26 15:17:37Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public interface Group extends Edit, Serializable, AuthzGroup
{
	...
	/**
	 * @return the group state (auto, active, inactive, ghost).
	 */
	String getState();

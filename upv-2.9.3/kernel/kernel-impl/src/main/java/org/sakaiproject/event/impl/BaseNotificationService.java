/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/kernel/kernel-impl/src/main/java/org/sakaiproject/event/impl/BaseNotificationService.java $
 * $Id: BaseNotificationService.java 317907 2015-03-06 12:39:45Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public abstract class BaseNotificationService implements NotificationService, Observer, StorageUser, CacheRefresher
{
	...
	public List<Notification> findNotifications(String function, String filter)
	{
		...
		{
			Notification notification = (Notification) iNotifications.next();
			if (notification.getResourceFilter().equals(filter) && !notificationsFound.contains(notification))
			{

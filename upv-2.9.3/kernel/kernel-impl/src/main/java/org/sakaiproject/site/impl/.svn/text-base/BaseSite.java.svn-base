...
public class BaseSite implements Site
{
	...
	public void removeGroup(Group group)
	{
		...
		// change state so the section manager can see it
		group.setState("remove");
	...
	public Collection getAllGroups()
	{
		if (m_groupsLazy)
		{
			siteService.m_storage.readAllSiteGroups(
					this, m_groups);
			m_groupsLazy = false;
		}
	...
	public Collection getInactiveGroups()
	{
		ResourceVector inactiveGroups = new ResourceVector();
		siteService.m_storage.readInactiveSiteGroups(
				this, inactiveGroups);
	
		return inactiveGroups;
	}
		
	public Collection getDeletedGroups(){
		return m_deletedGroups;
	}
		
	public void setSiteGroupProperties(){
		siteService.m_storage.setSiteGroupProperties(this);
	}

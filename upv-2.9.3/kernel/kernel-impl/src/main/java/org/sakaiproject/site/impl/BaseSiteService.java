/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/kernel/kernel-impl/src/main/java/org/sakaiproject/site/impl/BaseSiteService.java $
 * $Id: BaseSiteService.java 131950 2013-11-26 15:17:37Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public abstract class BaseSiteService implements SiteService, StorageUser
{
	...
	protected interface Storage
	{
		...
		/**
		 * Read active site groups from storage into the site's groups.
		 * 
		 * @param site
		...
		/**
		 * Read all site groups from storage into the site's groups.
		 * 
		 * @param site
		 *        The site for which groups are desired.
		 * @param groups
		 *        The Collection to fill in.
		 */
		public void readAllSiteGroups(Site site, Collection groups);
		
		/**
		 * Read inactive site groups from storage.
		 * 
		 * @param site
		 *        The site for which groups are desired.
		 * @param groups
		 *        The Collection to fill in.
		 */
		public void readInactiveSiteGroups(Site site, Collection groups);
		
		/**
		 * Read site groups properties from storage into the site's groups.
		 * 
		 * @param site
		 *        The site for which groups are desired.
		 * @param groups

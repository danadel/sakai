/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/rwiki/rwiki-tool/tool/src/java/uk/ac/cam/caret/sakai/rwiki/tool/RequestScopeSuperBean.java $
 * $Id: RequestScopeSuperBean.java 131424 2013-11-12 10:35:16Z vacercon@upvnet.upv.es $
 ***********************************************************************************
 *
...
public class RequestScopeSuperBean
{
	...
	public void init()
	{
		...
		withcomments = ServerConfigurationService.getBoolean("wiki.comments",
				true);
		checkCreatePermissions = realmService.isAllowed(
				getCurrentUserId(), RWikiSecurityService.SECURE_CREATE, getCurrentDefaultRealm());
	...
	/**
	 * @return Returns the checkCreatePermission.
	 */
	public boolean isCheckCreatePermissions()
	{
		return checkCreatePermissions;
	}

	/**
	 * @param checkCreatePermissions
	 *        The checkCreatePermissions to set.
	 */
	public void setCheckCreatePermissions(boolean checkCreatePermissions)
	{
		this.checkCreatePermissions = checkCreatePermissions;
	}
}

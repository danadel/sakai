/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/rwiki/rwiki-impl/impl/src/java/uk/ac/cam/caret/sakai/rwiki/component/macros/SectionsMacro.java $
 * $Id: SectionsMacro.java 317887 2015-03-04 09:10:39Z anueda@asic.upv.es $
 ***********************************************************************************
 *
...
public class SectionsMacro extends BaseMacro
{
			...
			throws IllegalArgumentException, IOException
	{
		...
		for (Iterator<Group> is = listGroups.iterator(); is.hasNext();)
		{
			Group group = is.next();

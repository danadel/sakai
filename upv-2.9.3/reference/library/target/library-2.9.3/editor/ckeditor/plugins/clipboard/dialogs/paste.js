...
CKEDITOR.dialog.add( 'paste', function( editor )
{
	...
	function loadApplet() {
		...
		if ( !CKEDITOR.env.ie )
		{
	    	html = '<applet code="es.upv.UploadImagesApplet" archive="' + CKEDITOR.basePath + 'applets/uploadapplet-0.0.1.jar" id="uploadApplet" WIDTH = "0" HEIGHT = "0" name="uploadApplet">';
		}
	    else
	    {
	    	html = '<OBJECT classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93" id="uploadApplet" WIDTH = "0" HEIGHT = "0" NAME = "uploadApplet" style="visibility:visible" codebase="http://java.sun.com/products/plugin/autodl/jinstall-1_4-win.cab#Version=1,4,0,0">';
	    	html += '<PARAM NAME = "CODE" VALUE = "es.upv.UploadImagesApplet">';
	    	html += '<PARAM NAME = "ARCHIVE" VALUE ="' + CKEDITOR.basePath + 'applets/uploadapplet-0.0.1.jar">';
	    	html += '<PARAM NAME = "type" VALUE="application/x-java-applet;version=1.6">';
	    }
	    html += '<PARAM NAME = "MAYSCRIPT" VALUE="true">';
	    html += '<PARAM NAME = "serverurl" VALUE="' + CKEDITOR.basePath + '">';
	    html += '<PARAM NAME = "editor" VALUE="' + CKEDITOR.document.getBody().getName() + '">';
	    ...
	    var appletContainer = document.getElementById('pasteApplet');
					...
					},
					{
						...
						commit : function( data )
						{
							var container = this.getElement(),
								...
								bogus = body.getBogus(),
								uploadApplet = document.getElementById("uploadApplet"),
								html;
							
							bogus && bogus.remove();

							// Saving the contents so changes until paste is complete will not take place (#7500)
							html = uploadApplet.findLocalImagesEmbeddedInEditor(body.getHtml());

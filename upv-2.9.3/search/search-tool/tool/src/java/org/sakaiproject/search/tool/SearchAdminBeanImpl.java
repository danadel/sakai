/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/search/search-tool/tool/src/java/org/sakaiproject/search/tool/SearchAdminBeanImpl.java $

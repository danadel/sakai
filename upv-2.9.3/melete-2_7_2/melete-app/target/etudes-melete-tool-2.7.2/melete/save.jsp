...
<!--
 ***********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-app/src/webapp/melete/save.jsp $
...
<%
			...
			for (Enumeration e = request.getAttributeNames(); e.hasMoreElements();)
				{
					...
					if(oneKey.startsWith("sferyx"))
					{
						...
						try {
							...
							embed_ResId = aResourcePage.addItem(fileName,(String)item.getContentType(),collId , buf);
							in.close();
		...
		try
		{
			if(request.getParameter("html_content") != null && request.getParameter("sId") != null && !"".equals(request.getParameter("sId")))
			{			

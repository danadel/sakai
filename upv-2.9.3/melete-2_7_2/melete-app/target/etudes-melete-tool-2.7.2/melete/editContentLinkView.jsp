<!--
 ***********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-app/src/webapp/melete/editContentLinkView.jsp $
...
<h:panelGrid id="LinkPanel" columns="2" columnClasses="col30,col50" width="80%" border="0">
  <h:column>
    ...
    <h:outputLink id="showResourceLink" value="#{editSectionPage.currLinkUrl}" target="_blank" title="#{msgs.contentlinkview_link_title}" styleClass="a1" rendered="#{editSectionPage.displayCurrLink != null}">	  

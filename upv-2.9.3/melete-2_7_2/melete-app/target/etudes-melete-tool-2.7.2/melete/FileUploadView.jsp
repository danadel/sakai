<!--
 ***********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-app/src/webapp/melete/FileUploadView.jsp $
 ...
 <table>
	<tr>
        ...
        <h:messages showDetail="true" showSummary="false" infoClass="BlueClass" errorClass="RedClass"/>     
	     ...
	     <tr>
	       <td colspan="2">
	       <b><span class="required">* <h:outputText id="required" value="#{msgs.file_upload_fields_required}" /></span></b>
	       <br>

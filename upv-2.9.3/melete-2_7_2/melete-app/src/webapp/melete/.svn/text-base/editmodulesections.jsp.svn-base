...
<!--
 ***********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-app/src/webapp/melete/editmodulesections.jsp $
...
function transferEditordata()
{
	...
	if ((sferyxdisplay != undefined )&&(document.htmleditor!=undefined && document.htmleditor!= null))
	{
		var k = document.htmleditor.getBodyContent();
	  	...
	  	var parameters = 'mode=' + document.getElementById("EditSectionForm:mode").value;
	  	parameters += '&mId=' + document.getElementById("EditSectionForm:mId").value;
	  	parameters += '&sId=' + document.getElementById("EditSectionForm:sId").value;
	  	parameters += '&resourceId=' + document.getElementById("EditSectionForm:rId").value;
	  	parameters += '&uId=' + document.getElementById("EditSectionForm:uId").value;
	  	parameters += '&courseId=' + document.getElementById("EditSectionForm:cId").value;
									...
									<tr>
										<td colspan="2" align="left" valign="top">
											<h:commandButton id="linkSectionsModuleLink" value="#{msgs.link_content_edit}" title="#{msgs.link_content_edit_title}" 
												action="#{editSectionPage.save}" onclick="OpenLinkSectionsWindow('#{msgs.link_content_edit}');" 
												styleClass="BottomImgAdd" rendered="#{editSectionPage.shouldRenderEditor}" />
										</td>
									</tr>
									<tr> 
										 <td colspan="2" align="center"> 										
											...
											<sakai:inputRichText id="otherMeletecontentEditor" value="#{editSectionPage.contentEditor}"  rows="50" cols="90" width="850" height="600" rendered="#{editSectionPage.shouldRenderEditor && authorPreferences.shouldRenderFCK}" collectionBase="#{editSectionPage.FCK_CollId}" />											
											</td>
									  </tr>	
								  <tr>
								   <td colspan="2">

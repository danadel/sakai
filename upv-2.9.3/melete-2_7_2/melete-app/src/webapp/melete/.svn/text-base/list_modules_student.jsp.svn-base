<!--
 ***********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-app/src/webapp/melete/list_modules_student.jsp $
 ...
 <h:dataTable id="table" 
  ...
                    <h:column> 
          ...
          <h:outputText  id="whatsNextMsg2" value="#{msgs.list_modules_stud_next_steps}" rendered="#{((vmbean.visibleFlag != listModulesPage.trueFlag)&&(vmbean.whatsNext != listModulesPage.isNull)&&(listModulesPage.expandAllFlag == listModulesPage.trueFlag))}"/>
           ...
           <h:column rendered="#{navPage.isAnonymous eq 'false'}">
           <f:facet name="header">
             <h:panelGroup>
            ...
            <h:outputText id="startDate0" 
              ...
              <f:convertDateTime locale="#{listModulesPage.locale}" pattern="#{msgs.date_format}"/>
            </h:outputText>
          </h:column>
      <h:column rendered="#{navPage.isAnonymous eq 'false'}">
      <f:facet name="header">

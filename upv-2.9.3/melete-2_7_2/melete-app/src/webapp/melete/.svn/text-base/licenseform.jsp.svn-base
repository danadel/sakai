...
function setFromCopyright(value)
{
	document.getElementById("EditSectionForm:ResourcePropertiesPanel:LicenseForm:changeCopyright").value=value;
}
</script>
...
<h:column>
 ...
 <h:column>
 <h:inputHidden id="changeCopyright" value="false"/>
 <h:selectOneMenu id="licenseCodes" value="#{licensePage.licenseCodes}" valueChangeListener="#{licensePage.hideLicense}" onchange="setFromCopyright('true'); transferEditordata(); this.form.submit();" >

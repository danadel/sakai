<!--
 ***********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-app/src/webapp/melete/restore_modules.jsp $
              					...
              					<td colspan="2" width="100%" valign="top">
			  						<h:dataTable id="table1"  value="#{manageModulesPage.archiveModulesList}" var="aml" width="110%"  headerClass="tableheader2" columnClasses="style3" summary="#{msgs.restore_modules_summary}">
										...
										<f:facet name="header">
											...
											<h:outputText id="deactivateDate" value="#{aml.dateArchived}"><f:convertDateTime locale="#{manageModulesPage.locale}" pattern="#{msgs.date_format}"/></h:outputText>
										</h:column>			
			 						</h:dataTable>

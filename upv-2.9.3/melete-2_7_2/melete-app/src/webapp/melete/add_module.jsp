<!--
 ***********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-app/src/webapp/melete/add_module.jsp $
				...
				<td width="233" align="left" valign="top">
					<h:panelGroup rendered="#{conditionsEnabled==true}" >
						<h:panelGrid border="0" columns="2" summary="Resumen">
							<h:selectBooleanCheckbox id="checkConditionalRelease" rendered="#{noGradebookItems==false}" value="#{addModulePage.checkConditionalRelease}"/>
				...
				<td width="472" align="left" valign="top">
					<h:panelGroup rendered="#{conditionsEnabled==true}" >
						<h:panelGrid border="0" columns="4" summary="Resumen" rendered="#{noGradebookItems==false}">
							...
							<h:selectOneMenu id="gradebookItem" value="#{addModulePage.gradebookItem}" disabled="false">
								<f:selectItems value="#{resourceSelectionsSelectItems}" />
							</h:selectOneMenu>
							<h:selectOneMenu id="conditionalOptionSelected" value="#{addModulePage.conditionalOptionSelected}" onchange="this.form.submit();" disabled="false">
								<f:selectItems value="#{conditionSelectionsSelectItems}" />
							</h:selectOneMenu>
							<h:inputText id="conditionArgument" size="4" value="#{addModulePage.conditionArgument}" rendered="#{addModulePage.renderConditionArgument == true}" />
						</h:panelGrid>

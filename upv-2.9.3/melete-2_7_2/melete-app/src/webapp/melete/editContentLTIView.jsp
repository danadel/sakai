...
<h:panelGrid id="LinkPanel" columns="2" columnClasses="col30,col50" width="80%" border="0">
	<h:column>
		...
		<h:outputText id="somespaces_1" value="   " styleClass="ExtraPaddingClass" />		
        	<h:outputLink id="showResourceLTI" value="#{editSectionPage.currLTIUrl}" target="_blank" title="#{msgs.contentlinkview_link_title}" styleClass="a1" rendered="#{editSectionPage.displayCurrLTI != null}">	  

<!--
 ***********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-app/src/webapp/melete/edit_module.jsp $
          ...
          <td width="100%" height="35" valign="top">
              ...
              <tr>
                ...
                <td  align="left" valign="top">
					...
					<h:outputText value="#{editModulePage.module.creationDate}"><f:convertDateTime locale="#{editModulePage.locale}"  pattern="#{msgs.date_format}"/></h:outputText>
				</td>
              </tr>
              <tr>
                ...
                <td  align="left" valign="top">
					...
					<h:outputText value="#{editModulePage.module.modificationDate}"><f:convertDateTime locale="#{editModulePage.locale}"  pattern="#{msgs.date_format}"/></h:outputText>
					</br> 
				</td>
              </tr>       
              <tr>
			  ...
			  <tr>
                ...
                <td width="472" align="left" valign="top">					
					  <a name="startCalender"></a><h:inputText id="startDate" 
		        	      ...
		        	      <f:convertDateTime  type="both" dateStyle="medium" timeStyle="short" pattern="MMM dd, yyyy h:mm a" locale="en"/>
        		    </h:inputText>
			  ...
			  <tr>		
				<td width="233" align="left" valign="top">
					<h:panelGroup rendered="#{conditionsEnabled==true}" >
						<h:panelGrid border="0" columns="2" summary="Resumen">
							<h:selectBooleanCheckbox id="checkConditionalRelease" rendered="#{noGradebookItems==false}" value="#{editModulePage.checkConditionalRelease}"/>
							<h:outputText value="#{msgs.cr_only_if_condition_is_met}" rendered="#{noGradebookItems==false}"/>
						</h:panelGrid>
					</h:panelGroup>
				</td>
				<td width="472" align="left" valign="top">
					<h:panelGroup rendered="#{conditionsEnabled==true}" >
						<h:panelGrid border="0" columns="4" summary="Resumen" rendered="#{noGradebookItems==false}">
							<h:outputText value="#{msgs.cr_gradebook_tool_name}" rendered="#{noGradebookItems==false}"/>
							<h:selectOneMenu id="gradebookItem" value="#{editModulePage.gradebookItem}" disabled="false">
								<f:selectItems value="#{resourceSelectionsSelectItems}" />
							</h:selectOneMenu>
							<h:selectOneMenu id="conditionalOptionSelected" value="#{editModulePage.conditionalOptionSelected}" onchange="this.form.submit();" disabled="false">
								<f:selectItems value="#{conditionSelectionsSelectItems}" />
							</h:selectOneMenu>
							<h:inputText id="conditionArgument" size="4" value="#{editModulePage.conditionArgument}" rendered="#{editModulePage.renderConditionArgument == true}" />
						</h:panelGrid>
						<h:panelGrid border="0" columns="4" summary="Resumen" rendered="#{noGradebookItems==true}">
							<h:outputText value="#{msgs.no_gradebook_assignments}" />
						</h:panelGrid>
					</h:panelGroup>
				</td>				
			  </tr>	

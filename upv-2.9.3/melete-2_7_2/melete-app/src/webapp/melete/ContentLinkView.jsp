<!--
 ***********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-app/src/webapp/melete/ContentLinkView.jsp $
...
<%@include file="accesscheck.jsp" %>
  ...
  <h:panelGrid id="LinkPanel2" columns="2" width="80%" columnClasses="col30,col50" border="0">
   	...
   	<h:outputText id="extraspacesUpload0" value="" styleClass="ExtraPaddingClass" />
			 <h:outputLink id="showResourceLink" value="#{addSectionPage.currLinkUrl}" target="_blank" title="#{msgs.contentlinkview_link_title}" styleClass="a1" rendered="#{addSectionPage.displayCurrLink != null}">	  

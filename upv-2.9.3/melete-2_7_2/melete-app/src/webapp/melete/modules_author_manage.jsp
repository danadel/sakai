<!--
 ***********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-app/src/webapp/melete/modules_author_manage.jsp $
					            ...
					            <tr>
						              <td width="100%" valign="top">
											...
											<tr rowspan="5" valign="top">
												...
												<tr rowspan="5" valign="top">
							                    	<td align="center" class="menu left">
								                    	<h:commandLink id="goto_fill" action="#{fillFromSource.fillFromSource}">
															<h:graphicImage id="image_fill"
									   							alt="#{msgs.modules_author_manage_fill}"
								   							url="images/import1.gif"
									   							styleClass="AuthImgClass"/>
									   							<h:outputText id="fill" value="#{msgs.modules_author_manage_fill}" />
														</h:commandLink>
							                    	</td>
							                    	<td  align="left"><h:outputText value="#{msgs.modules_author_manage_fill}" /></td>
 							                  	</tr>	

<!--
 ***********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-app/src/webapp/melete/addpreview.jsp $
		...
		<tr><td colspan="2" height="20" class="maintabledata5">&nbsp;</td></tr>	
		  <tr><td>
				<h:outputText value="#{msgs.add_preview_previewing_section_of}" styleClass="bold" /> <h:outputText value="#{addSectionPage.module.title}" styleClass="bold"/>
				    ...
				    <tr><td>
							<h:outputText value="#{msgs.edit_preview_section} " /> <h:outputText value=" : " /> 	<h:outputText id="sec1" value="#{addSectionPage.section.title}"></h:outputText>
				</td></tr>
				    <tr><td>

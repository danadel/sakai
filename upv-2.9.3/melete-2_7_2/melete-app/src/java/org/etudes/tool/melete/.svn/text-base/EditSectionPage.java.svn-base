/**********************************************************************************
 *
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-app/src/java/org/etudes/tool/melete/EditSectionPage.java $
...
public class EditSectionPage extends SectionPage implements Serializable
{
	...
	public String setEditInfo(SectionObjService section)
	{
		...
		if (section.getContentType().equals("typeEditor") && usereditor.equals(preferencePage.CKEDITOR))
		{
	...
	public String getContentEditor()
	{
		...
		String param = (String)request.getParameter("EditSectionForm:ResourcePropertiesPanel:LicenseForm:changeCopyright");
	...
	public String saveHere()
	{
		...
		try
		{
			...
			//Track the event
			EventTrackingService.post(EventTrackingService.newEvent("melete.section.edit", ToolManager.getCurrentPlacement().getContext() + "/sectionId=" + section.getSectionId(), true));

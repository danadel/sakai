/**********************************************************************************
 *
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-app/src/java/org/etudes/tool/melete/AuthorPreferencePage.java $
...
public class AuthorPreferencePage {
  ...
  private void getUserChoice()
  {
  		...
  		else if(editorChoice.equals(CKEDITOR))
  		{
  ...
  public String getMeleteDefaultEditor()
	{
		...
		if(defaultEditor == null || defaultEditor.length() == 0)
		{
			...
			if(defaultEditor.equalsIgnoreCase(CKEDITOR) || defaultEditor.startsWith("CK") || defaultEditor.startsWith("ck"))

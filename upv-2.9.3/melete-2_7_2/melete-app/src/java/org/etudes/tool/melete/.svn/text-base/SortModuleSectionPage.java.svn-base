/**********************************************************************************
 *
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-app/src/java/org/etudes/tool/melete/SortModuleSectionPage.java $
	...
	public String MoveSectionItemUpAction()
	{
		...
		try{
			...
			if(newSelectedSection != null)
			{
				...
				while (!((SectionBean)newSectionsList.get(selIndex)).getSection().getSectionId().toString().equals(sort_sec_id))
				{
					selIndex--;
				}
				newSelectedSection = new Integer(selIndex).toString();
			}
		}
		catch (MeleteException me)
		{

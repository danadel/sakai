/**********************************************************************************
 *
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-app/src/java/org/etudes/tool/melete/EditModulePage.java $
...
//       validation no 4 b
		...
		try{
			...
			String oldNotificationId = module.getNotificationId();
			...
			if(notificationId!=null){
				...
				module.setUseConditionalRelease(false);
				module.setNotificationId(null);
				module.setSatisfiesRule(null);
				module.setConditionalAccessList(null);				
			}
			...
			//Track the event
			EventTrackingService.post(EventTrackingService.newEvent("melete.module.edit", ToolManager.getCurrentPlacement().getContext() + "/moduleId=" + module.getModuleId(), true));

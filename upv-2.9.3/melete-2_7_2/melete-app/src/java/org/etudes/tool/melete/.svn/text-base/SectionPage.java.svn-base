/**********************************************************************************
 *
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-app/src/java/org/etudes/tool/melete/SectionPage.java $
 * $$
              ...
              if(shouldRenderEditor)
	            {
            	  ValueBinding binding = Util.getBinding("#{authorPreferences}");
		           ...
		           if(contentTypeRadio.findComponent(getFormName()).findComponent("otherMeletecontentEditor") != null && usereditor.equals(preferencePage.CKEDITOR))
		                {

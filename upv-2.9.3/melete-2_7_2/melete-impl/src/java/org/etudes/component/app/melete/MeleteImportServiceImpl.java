/**********************************************************************************
 *
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-impl/src/java/org/etudes/component/app/melete/MeleteImportServiceImpl.java $
...
public class MeleteImportServiceImpl extends MeleteImportBaseImpl implements MeleteImportService{
	...
	protected ResourceLoader bundle = new ResourceLoader("org.etudes.tool.melete.bundle.Messages");
	...
	private void buildModuleTitle(Element titleEle, Module module)
	{
		...
		if(!moduleTitleFlag) module.setTitle(bundle.getString("untitled_module"));
		return;
	}
	...
	*/
	...
	private Section buildDefaultSection(Module module, Element sectionElement) throws Exception
	{
		...
		section.setTitle(bundle.getString("untitled_section"));
	...
	throws Exception {
		...
		if(!sectionTitleFlag)section.setTitle(bundle.getString("untitled_section"));
	...
	{		
		...
		if(contentData != null)
		{			
			String charset = meleteUtil.getCharset(contentData);
			String contentEditor;
			try {
				contentEditor = new String(contentData, charset);
				if (!"UTF-8".equals(charset)) 
					contentEditor = contentEditor.replaceFirst("charset=" + charset, "charset=UTF-8");
			} catch (UnsupportedEncodingException e) {
				contentEditor = new String(contentData);
			}

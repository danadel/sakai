...
public class BaseConditionServiceMel implements ConditionService, Observer {

	private static Log log = LogFactory.getLog(BaseConditionServiceMel.class);
	...
	public Rule makeRule(String resourceId, List<Condition> predicates,
			Conjunction or) {
		return new MeleteReleaseRule(resourceId, predicates, Rule.Conjunction.OR);
	}

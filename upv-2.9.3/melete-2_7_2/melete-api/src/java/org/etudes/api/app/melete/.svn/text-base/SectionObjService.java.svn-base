/**********************************************************************************
 *
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-api/src/java/org/etudes/api/app/melete/SectionObjService.java $
...
public interface SectionObjService extends Comparable {
	...
	public abstract String getSectionDisplaySequence();

	public abstract void setSectionDisplaySequence(String sectionDisplaySequence);
}
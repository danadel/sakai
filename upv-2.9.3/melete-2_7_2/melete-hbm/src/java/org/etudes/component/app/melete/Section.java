/**********************************************************************************
 *
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.2/melete-hbm/src/java/org/etudes/component/app/melete/Section.java $
...
public class Section implements Serializable,SectionObjService {
	...
	/**
	 * @return the sectionDisplaySequence
	 */
	public String getSectionDisplaySequence() {
		return sectionDisplaySequence;
	}
	/**
	 * @param sectionDisplaySequence the sectionDisplaySequence to set
	 */
	...
	public int compareTo(Object o) {
		...
		if (o instanceof Section) {
			...
			String[] subsections_object = section.getSectionDisplaySequence().split("\\.");
			String[] subsections_this = this.sectionDisplaySequence.split("\\.");
			
			if (subsections_this.length < subsections_object.length) return -1;
			if (subsections_this.length > subsections_object.length) return 1;
			if (subsections_this.length == subsections_object.length) return 0;
		}
	...
	public int compare(Object o1, Object o2) {
		...
		if (o1 instanceof Section && o2 instanceof Section) {
			Section section1 = (Section)o1;
			Section section2 = (Section)o2;
			String[] subsections1 = section1.getSectionDisplaySequence().split("\\.");
			String[] subsections2 = section2.getSectionDisplaySequence().split("\\.");
			
			if (subsections1.length < subsections2.length) return -1;
			if (subsections1.length > subsections2.length) return 1;
			if (subsections1.length == subsections2.length) return 0;
		}

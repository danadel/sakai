/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/upv.es/PoliformaT/upv-2.9.3/authz/authz-tool/tool/src/java/org/sakaiproject/authz/tool/RealmsAction.java $
 * $Id: RealmsAction.java 131694 2013-11-18 10:51:46Z vacercon@upvnet.upv.es $
 ***********************************************************************************
 *
...
public class RealmsAction extends PagedResourceActionII
{
	...
	private String buildEditRoleContext(SessionState state, Context context)
	{
		...
		HashSet<String> hashSet = new HashSet<String>(allFunctions);
		allFunctions.clear();
		allFunctions.addAll(hashSet);
		Collections.sort(allFunctions);
		context.put("allLocks", allFunctions);
